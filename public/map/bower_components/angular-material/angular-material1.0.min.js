...
!function (e, t, n) {
    ...
    !function () {
        ...
        function e(e, n) {
            ...
            function g(e, o, i, a) {
                ...
                for (var d = u(o); ;) {
                    ...
                    if (r(s) ? c = E[s] : n && (c = e ? f() : p(), s = u(c)), null === c || s === a) return null;
                    if (i(c)) return c;
        ...
        function e(e, n, o) {
            ...
            function a(e) {
                var t = h[e];
                return t || (t = h[e] = o.matchMedia(e)), t.addListener(d), p[t.media] = !!t.matches
            }
        ...
        function o(o, r, a, d, s, c, l, m, u) {
            function h(e) {
                return e[0] || e
            }

            var p = c.startSymbol(), f = c.endSymbol(), g = "{{" === p && "}}" === f, b = function (e, n, o) {
                var i = !1;
                if (e && e.length) {
                    var r = u.getComputedStyle(e[0]);
                    i = t.isDefined(r[n]) && (o ? r[n] == o : !0)
                }
                return i
            }, E = {
                dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
                    ...
                    var o = h(e);
                    t = h(t || o.offsetParent || document.body);
                    var i = o.getBoundingClientRect(),
                        r = n ? t.getBoundingClientRect() : {left: 0, top: 0, width: 0, height: 0};
                    ...
                    var i, r = "[md-autofocus]";
                    return i = o(e, n || r), i || n == r || (i = o(e, "[md-auto-focus]"), i || (i = o(e, r))), i
                    ...
                    function i(e) {
                        ...
                        e = t.element(e || d)[0];
                        var o = 50,
                            i = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>').css("z-index", o);
                        return e.appendChild(i[0]), i.on("wheel", n), i.on("touchmove", n), function () {
                            i.off("wheel"), i.off("touchmove"), i[0].parentNode.removeChild(i[0]), delete E.disableScrollAround._enableScrolling
                        }
                    }

                    function r() {
                        var e = d.parentNode, t = e.style.cssText || "", n = d.style.cssText || "", o = E.scrollTop(d),
                            i = d.clientWidth;
                        return d.scrollHeight > d.clientHeight + 1 && (a(d, {
                            position: "fixed",
                            width: "100%",
                            top: -o + "px"
                        }), a(e, {overflowY: "scroll"})), d.clientWidth < i && a(d, {overflow: "hidden"}), function () {
                    ...
                    var d = o[0].body, s = r(), c = i(n);
                    return E.disableScrollAround._enableScrolling = function () {
                        --E.disableScrollAround._count || (s(), c(), delete E.disableScrollAround._enableScrolling)
                    }
                    ...
                    var n;
                    return function () {
                        var o = this, i = arguments, r = E.now();
                    ...
                    function d(e) {
                        ...
                        if (e) for (var n = 0, o = e.length; o > n; n++) {
                            var i = e[n];
                            if (!t) for (var a = 0, d = i.childNodes.length; d > a; a++) t = t || r([i.childNodes[a]])
                        }
                        return t
                    }

                    var s = r(e);
                    return !s && i && l.warn(E.supplant("Unable to find node '{0}' in element '{1}'.", [n, e[0].outerHTML])), t.element(s || e)
                    ...
                    function o() {
                        var e = n && n.$$destroyed, t = e ? [] : i.queue, o = e ? null : i.digest;
                        i.queue = [], i.timeout = null, i.digest = !1, t.forEach(function (e) {
                            e()
                        }), o && d.$digest()
                    }

                    var i = E.nextTick, a = i.timeout, s = i.queue || [];
                    return s.push(e), null == t && (t = !0), i.digest = i.digest || t, i.queue = s, a || (i.timeout = r(o, 0, !1))
                }, processTemplate: function (e) {
                    return g ? e : e && t.isString(e) ? e.replace(/\{\{/g, p).replace(/}}/g, f) : e
        ...
        function e(e, n, o, i, r, a) {
            this.compile = function (d) {
                var s = d.templateUrl, c = d.template || "", l = d.controller, m = d.controllerAs,
                    u = t.extend({}, d.resolve || {}), h = t.extend({}, d.locals || {}),
                    p = d.transformTemplate || t.identity, f = d.bindToController;
                return t.forEach(u, function (e, n) {
                    t.isString(e) ? u[n] = o.get(e) : u[n] = o.invoke(e)
                }), t.extend(u, h), s ? u.$template = n.get(s, {cache: a}).then(function (e) {
                    return e.data
                }) : u.$template = e.when(c), e.all(u).then(function (e) {
                    var n, o = p(e.$template, d), a = d.element || t.element("<div>").html(o.trim()).contents(),
                        s = i(a);
                    return n = {
                        locals: e, element: a, link: function (o) {
                            if (e.$scope = o, l) {
                                var i = r(l, e, !0);
                                f && t.extend(i.instance, e);
                                var d = i();
        ...
        function e(e, n, o, i) {
            function r(e, o, i) {
                ...
                !r || r.hasAttribute(o) && 0 !== r.getAttribute(o).length || c(r, o) || (i = t.isString(i) ? i.trim() : "", i.length ? e.attr(o, i) : n.warn('ARIA: Attribute "', o, '", required for accessibility, is missing on node:', r))
            }
            ...
            function d(e, t) {
                var n = s(e) || "", o = n.indexOf(i.startSymbol()) > -1;
                o ? a(e, t, function () {
                    return s(e)
                }) : r(e, t, n)
            }
            ...
            return {expect: r, expectAsync: a, expectWithText: d}
        }
        ...
        function o(n, o, i) {
            ...
            function s(e, o) {
                var i = new n(e);
                return t.extend(i, o), p[e] = i, g
            }

            var c = navigator.userAgent || navigator.vendor || e.opera, m = c.match(/ipad|iphone|ipod/i),
                u = c.match(/android/i), h = "undefined" != typeof e.jQuery && t.element === e.jQuery,
                g = {handler: s, register: a, isHijackingClicks: (m || u) && !h && !f};
        ...
        function a(e, n) {
            ...
            function r(e, t) {
                var o;
                for (var i in p) o = p[i], o instanceof n && ("start" === e && o.cancel(), o[e](t, u))
            }

            function a(e) {
                if (!u) {
                    var t = +Date.now();
                    h && !s(e, h) && t - h.endTime < 1500 || (u = d(e), r("start", e))
                }
            }
            ...
            function f(e) {
                u && s(e, u) && (l(e, u), u.endTime = +Date.now(), r("end", e), h = u, u = null)
            }
            ...
            var E = "mousedown touchstart pointerdown", v = "mousemove touchmove pointermove",
                $ = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
            t.element(document).on(E, a).on(v, m).on($, f).on("$$mdGestureReset", function () {
                h = u = null
            })
        }
        ...
        function e() {
            function e(e) {
                ...
                var a = ["onHide", "onShow", "onRemove"], d = {}, s = {presets: {}},
            ...
            function o(e, o, i, r, a, d, s, c, l, m, u) {
                return function () {
                    function h(e) {
                        e = e || {};
                        var t = new b(e || {}), n = !e.skipHide && $.length ? E.hide() : o.when(!0);
                    ...
                    function b(u) {
                        function h() {
                            return o(function (e, t) {
                                ...
                                g(u).then(function (t) {
                                    A = b(t, u), T = M(A, u, t.controller).then(e, n)
                                }, n)
                            })
                        }
                        ...
                        function p(e, n, i) {
                            ...
                            return A ? (u = t.extend(u || {}, i || {}), u.cancelAutoHide && u.cancelAutoHide(), u.element.triggerHandler("$mdInterimElementRemove"), u.$destroy === !0 ? y(u.element, u).then(function () {
                                n && a(e) || r(e)
                        ...
                        var C, A, T = o.when(!0);
                        return u = f(u), C = {options: u, deferred: o.defer(), show: h, remove: p}
                    }

                    var E, v = !1, $ = [];
                    return E = {show: h, hide: p, cancel: f, destroy: g, $injector_: u}
                }
            }
        ...
        !function () {
            function e(e) {
                function a(e) {
                    return e.replace(s, "").replace(c, function (e, t, n, o) {
                        return o ? n.toUpperCase() : n
                    })
                }

                var s = /^((?:x|data)[\:\-_])/i, c = /([\:\-\_]+(.))/g,
            ...
            function i(e) {
                function n(t, n, o) {
                    var i = a(n, e, o), r = o.$observe(o.$normalize(e), i);
                    i(u(e, o, "")), t.$on("$destroy", function () {
                        r()
                    })
                }
                ...
                return ["$mdUtil", "$interpolate", "$log", function (o, i, r) {
                    return f = o, g = i, b = r, {
                        restrict: "A", compile: function (o, i) {
                            var r;
                            return A.enabled && (s(e, i, o, b), c(e, u(e, i, ""), l(o, e, i)), r = n), r || t.noop
                        }
                    }
                }]
            }
            ...
            function r(e) {
                ...
                return ["$mdUtil", "$interpolate", "$log", function (o, i, r) {
                    return f = o, g = i, b = r, {
                        restrict: "A", compile: function (o, i) {
                            var r;
                            return A.enabled && (c(e, u(e, i, ""), l(o, e, i)), n(null, o), r = n), r || t.noop
                        }
                    }
                }]
            }
            ...
            function a(e, n) {
                ...
                return function (i) {
                    var r = c(n, i || "");
                    t.isDefined(r) && (o && e.removeClass(o), o = r ? n + "-" + r.replace(v, "-") : n, e.addClass(o))
                }
            }
            ...
            function s(e, t, n, o) {
                ...
                switch (e.replace(E, "")) {
                    case"flex":
                        "md-button" != d && "fieldset" != d || (r = "<" + d + " " + e + "></" + d + ">", a = "https://github.com/philipwalton/flexbugs#9-some-html-elements-cant-be-flex-containers", i = "Markup '{0}' may not work as expected in IE Browsers. Consult '{1}' for details.", o.warn(f.supplant(i, [r, a])))
                }
            }
            ...
            var f, g, b, E = /(-gt)?-(sm|md|lg|print)/g, v = /\s+/g,
                $ = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], M = ["row", "column"],
                y = ["", "start", "center", "end", "stretch", "space-around", "space-between"],
                C = ["", "start", "center", "end", "stretch"], A = {enabled: !0, breakpoints: []};
        ...
        function e(e, n) {
            ...
            return i = {
                notFoundError: function (t) {
                    ...
                    if (!o(e)) return null;
                    var t, n, i;
                    for (t = 0, n = r.length; n > t; t++) if (i = r[t], i.$$mdHandle === e) return i;
                    return null
                    ...
                    if (o(e)) {
                        var t = n.defer(), r = i.get(e);
                        return r ? t.resolve(r) : a[e] = t, t.promise
                    }
        ...
        function n(e) {
            function n(n, i, r) {
                return i.controller("mdNoInk") ? t.noop : e.instantiate(o, {$scope: n, $element: i, rippleOptions: r})
            }
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$injector"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil"], o.prototype.color = function (e) {
            ...
            function n(e) {
                var t = "#" === e[0] ? e.substr(1) : e, n = t.length / 3, o = t.substr(0, n), i = t.substr(n, n),
                    r = t.substr(2 * n);
            ...
            if (this.isRippleAllowed()) {
                var r = this, d = t.element('<div class="md-ripple"></div>'), s = this.$element.prop("clientWidth"),
                    c = this.$element.prop("clientHeight"), l = 2 * Math.max(Math.abs(s - e), e),
                    m = 2 * Math.max(Math.abs(c - n), n), u = i(this.options.fitRipple, l, m),
                ...
                }, .35 * a, !1), this.options.dimBackground && this.container.css({backgroundColor: h}), this.container.append(d), this.ripples.push(d), d.addClass("md-ripple-placed"), this.$mdUtil.nextTick(function () {
        ...
        function e(e) {
            ...
            function s(e, n) {
                if (u[e]) return u[e];
                n = n || "default";
                var o = "string" == typeof n ? u[n] : n, i = new c(e);
                return o && t.forEach(o.colors, function (e, n) {
                    i.colors[n] = {name: e.name, hues: t.extend({}, e.hues)}
                }), u[e] = i, i
            }
            ...
            function c(e) {
                function n(e) {
                    if (e = 0 === arguments.length ? !0 : !!e, e !== o.isDark) {
                        o.isDark = e, o.foregroundPalette = o.isDark ? f : p, o.foregroundShadow = o.isDark ? g : b;
                        var n = o.isDark ? A : C, i = o.isDark ? C : A;
                ...
                o.name = e, o.colors = {}, o.dark = n, n(!1), M.forEach(function (e) {
                    ...
                    o[e + "Palette"] = function (i, r) {
                        var a = o.colors[e] = {name: i, hues: t.extend({}, n, r)};
                        return Object.keys(a.hues).forEach(function (e) {
                            ...
                            if (-1 == T.indexOf(t)) throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", o.name).replace("%3", e).replace("%4", i).replace("%5", T.join(", ")))
                        }), o
                    }, o[e + "Color"] = function () {
            ...
            function h(e, o) {
                ...
                function r(n, r) {
                    function a() {
                        return s = r.controller("mdTheme") || n.data("$mdThemeController"), s && s.$mdTheme || ("default" == v ? "" : v)
                    }
                    ...
                    var s = r.controller("mdTheme"), c = n.attr("md-theme-watch"),
                        l = ($ || t.isDefined(c)) && "false" != c;
                ...
                return a.THEMES = t.extend({}, u), a.inherit = r, a.registered = i, a.defaultTheme = function () {
                    return v
            ...
            m = {}, u = {};
            var E, v = "default", $ = !1;
            return t.extend(m, e), h.$inject = ["$rootScope", "$log"], E = {
                definePalette: o,
                extendPalette: i,
                theme: s,
                setNonce: function (e) {
            ...
            return {
                priority: 100, link: {
                    pre: function (o, i, r) {
                        ...
                        i.data("$mdThemeController", a), a.$setTheme(t(r.mdTheme)(o)), r.$observe("mdTheme", a.$setTheme)
                    }
                }
            }
        }
        ...
        function r(e, n, o) {
            s(e, n), o = o.replace(/THEME_NAME/g, e.name);
            var i = [], r = e.colors[n], a = new RegExp(".md-" + e.name + "-theme", "g"),
                d = new RegExp("('|\")?{{\\s*(" + n + ")-(color|contrast)-?(\\d\\.?\\d*)?\\s*}}(\"|')?", "g"),
                c = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g,
                u = m[r.name];
            return o = o.replace(c, function (t, n, o, i, r) {
                return "foreground" === n ? "shadow" == o ? e.foregroundShadow : e.foregroundPalette[o] || e.foregroundPalette[1] : (0 === o.indexOf("hue") && (o = e.colors[n].hues[o]), l((m[e.colors[n].name][o] || "")[r ? "contrast" : "value"], i))
            }), t.forEach(r.hues, function (t, n) {
                var r = o.replace(d, function (e, n, o, i, r) {
                    return l(u[t]["color" === i ? "value" : "contrast"], r)
                });
                if ("default" !== n && (r = r.replace(a, ".md-" + e.name + "-theme.md-" + n)), "default" == e.name) {
        ...
        function a(e) {
            function n(e) {
                var n = e.contrastDefaultColor, o = e.contrastLightColors || [], i = e.contrastStrongLightColors || [],
                    r = e.contrastDarkColors || [];
                "string" == typeof o && (o = o.split(" ")), "string" == typeof i && (i = i.split(" ")), "string" == typeof r && (r = r.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function (a, d) {
                    function s() {
                        return "light" === n ? r.indexOf(d) > -1 ? E : i.indexOf(d) > -1 ? $ : v : o.indexOf(d) > -1 ? i.indexOf(d) > -1 ? $ : v : E
                    }
            ...
            if (i && 0 !== r.length) {
                ...
                M.forEach(function (e) {
                    ...
                    for (var t, n = (e.match(s), 0); t = M[n]; n++) if (e.indexOf(".md-" + t) > -1) return _[t] += e;
        ...
        function d(e, t) {
            var n = u[e], o = document.head, i = o ? o.firstElementChild : null;
            h[e] || (M.forEach(function (e) {
                for (var a = r(n, e, _[e]); a.length;) {
                    var d = a.shift();
                    if (d) {
                        var s = document.createElement("style");
                        s.setAttribute("md-theme-style", ""), t && s.setAttribute("nonce", t), s.appendChild(document.createTextNode(d)), o.insertBefore(s, i)
                    }
                }
            }), n.colors.primary.name == n.colors.accent.name && console.warn("$mdThemingProvider: Using the same palette for primary and accent. This violates the material design spec."), h[n.name] = !0)
        }
        ...
        function c(e) {
            ...
            if ("#" == e.charAt(0) && (e = e.substring(1)), /^([a-fA-F0-9]{3}){1,2}$/g.test(e)) {
                var n = e.length / 3, o = e.substr(0, n), i = e.substr(n, n), r = e.substr(2 * n);
        ...
        t.module("material.core.theming", ["material.core.theming.palette"]).directive("mdTheme", o).directive("mdThemable", i).provider("$mdTheming", e).run(a);
        var m, u, h = {}, p = {
                name: "dark",
                1: "rgba(0,0,0,0.87)",
                2: "rgba(0,0,0,0.54)",
            ...
            }, g = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", b = "", E = c("rgba(0,0,0,0.87)"),
            v = c("rgba(255,255,255,0.87)"), $ = c("rgb(255,255,255)"), M = ["primary", "accent", "warn", "background"],
            y = "primary", C = {
        ...
        var T = ["50", "100", "200", "300", "400", "500", "600", "700", "800", "900", "A100", "A200", "A400", "A700"],
            w = !1, k = null;
        e.$inject = ["$mdColorPalette"], o.$inject = ["$mdTheming", "$interpolate", "$log"], i.$inject = ["$mdTheming"];
        var _ = {};
        a.$inject = ["$injector"]
    }(), function () {
            ...
            return a = {
                translate3d: function (e, t, n, o) {
                    ...
                    return n(function (n, a) {
                        function d(t) {
                            t && t.target !== e[0] || (t && o.cancel(s), e.off(i.CSS.TRANSITIONEND, d), n())
                        }

                        t = t || {};
                        var s = o(d, t.timeout || r);
                        e.on(i.CSS.TRANSITIONEND, d)
                    })
                }, calculateTransformValues: function (e, t) {
                    function n() {
                        var t = e ? e.parent() : null, n = t ? t.parent() : null;
                        return n ? a.clientRect(n) : null
                    }

                    var o = t.element, i = t.bounds;
                    if (o || i) {
                        var r = o ? a.clientRect(o) || n() : a.copyRect(i),
                            d = a.copyRect(e[0].getBoundingClientRect()), s = a.centerPointFor(d),
                            c = a.centerPointFor(r);
                        return {
                            centerX: c.x - s.x,
                            centerY: c.y - s.y,
                            scaleX: Math.round(100 * Math.min(.5, r.width / d.width)) / 100,
                            scaleY: Math.round(100 * Math.min(.5, r.height / d.height)) / 100
                        }
                    }
                    ...
                    var i = "translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )",
                        r = t.bind(null, e.supplant, i);
                    return r(a.calculateTransformValues(n, o))
                }, calculateSlideToOrigin: function (n, o) {
                    var i = "translate3d( {centerX}px, {centerY}px, 0 )", r = t.bind(null, e.supplant, i);
                    return r(a.calculateTransformValues(n, o))
                }, toCss: function (e) {
                    function n(e, n, i) {
                    ...
                    var o = {}, r = "left top right bottom width height x y min-width min-height max-width max-height";
                    return t.forEach(e, function (e, a) {
                        if (!t.isUndefined(e)) if (r.indexOf(a) >= 0) o[a] = e + "px"; else switch (a) {
                            case"transition":
                    ...
                    return t.forEach(i.CSS.TRANSFORM.split(" "), function (t) {
                        r[t] = e
                    }), n && (o = o || "all 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) !important", r.transition = o), r
        ...
        t.module("material.core").factory("$$mdAnimate", ["$q", "$timeout", "$mdConstant", "$animateCss", function (t, n, o, i) {
            return function (r) {
                return e(r, t, n, o, i)
            }
        }])
        ...
        t.version.minor >= 4 ? t.module("material.core.animate", []) : !function () {
            ...
            var n = t.forEach, o = t.isDefined(document.documentElement.style.WebkitAppearance),
                i = o ? "-webkit-" : "", r = (o ? "webkitTransitionEnd " : "") + "transitionend",
                a = (o ? "webkitAnimationEnd " : "") + "animationend", d = ["$document", function (e) {
                    return function () {
            ...
            t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", c).factory("$$rAFMutex", s).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", "$animate", function (t, d, s, c, l, m, u) {
                function h(o, d) {
                    var c = [], l = M(o), h = l && u.enabled(), g = !1, C = !1;
                    h && (d.transitionStyle && c.push([i + "transition", d.transitionStyle]), d.keyframeStyle && c.push([i + "animation", d.keyframeStyle]), d.delay && c.push([i + "transition-delay", d.delay + "s"]), d.duration && c.push([i + "transition-duration", d.duration + "s"]), g = d.keyframeStyle || d.to && (d.duration > 0 || d.transitionStyle), C = !!d.addClass || !!d.removeClass, y(o, !0));
                    var A = h && (g || C);
                    v(o, d);
                    var T, w, k = !1;
                    return {
                        close: t.close, start: function () {
                            function t() {
                                return k ? void 0 : (k = !0, T && w && o.off(T, w), p(o, d), E(o, d), n(c, function (t) {
                                    l.style[e(t[0])] = ""
                                }), u.complete(!0), u)
                            }
                            ...
                            return b(function () {
                                ...
                                var h = s.delay, g = 1e3 * h, b = s.duration, E = 1e3 * b, v = Date.now();
                                T = [], s.transitionDuration && T.push(r), s.animationDuration && T.push(a), T = T.join(" "), w = function (e) {
                                    e.stopPropagation();
                                    var n = e.originalEvent || e, o = n.timeStamp || Date.now(),
                                        i = parseFloat(n.elapsedTime.toFixed(3));
                                    Math.max(o - v, 0) >= g && i >= b && t()
                                }, o.on(T, w), $(o, d), m(t, g + 1.5 * E, !1)
                            }), u
                        }
                    }
                }
                ...
                function f(e) {
                    ...
                    var i = M(e), r = t.getComputedStyle(i), a = g(r[n("transitionDuration")]),
                        d = g(r[n("animationDuration")]), s = g(r[n("transitionDelay")]), c = g(r[n("animationDelay")]);
                ...
                function b(e) {
                    C && C(), A.push(e), C = d(function () {
                        C = null;
                        for (var e = c(), t = 0; t < A.length; t++) A[t](e);
                        A.length = 0
                    })
                }
                ...
                function y(t, n) {
                    var o = M(t), r = e(i + "transition-delay");
                    o.style[r] = n ? "-9999s" : ""
                }
        ...
        t.module("material.components.backdrop", ["material.core"]).directive("mdBackdrop", ["$mdTheming", "$animate", "$rootElement", "$window", "$log", "$$rAF", "$document", function (e, t, n, o, i, r, a) {
            function d(d, c, l) {
                ...
                t.pin && t.pin(c, n), r(function () {
                    var t = c.parent()[0];
                    if (t) {
                        "BODY" == t.nodeName && c.css({position: "fixed"});
                        var n = o.getComputedStyle(t);
                        "static" == n.position && i.warn(s)
                    }
                    c.parent().length && e.inherit(c, c.parent())
                })
            }
        ...
        function n(e) {
            function n(e, n, r, a, d, s, c) {
                function l(o, i, c, l) {
                    i = r.extractElementByName(i, "md-bottom-sheet"), i.attr("tabindex", "-1"), c.disableBackdrop || (h = r.createBackdrop(o, "md-bottom-sheet-backdrop md-opaque"), h[0].tabIndex = -1, c.clickOutsideToClose && h.on("click", function () {
                        r.nextTick(d.cancel, !0)
                    }), a.inherit(h, c.parent), e.enter(h, c.parent, null));
                    var m = new u(i, c.parent);
                    return c.bottomSheet = m, a.inherit(m.element, c.parent), c.disableParentScroll && (c.restoreScroll = r.disableScrollAround(m.element, c.parent)), e.enter(m.element, c.parent, h).then(function () {
                        var e = r.findFocusTarget(i) || t.element(i[0].querySelector("button") || i[0].querySelector("a") || i[0].querySelector("[ng-click]")) || h;
                ...
                function u(e, t) {
                    ...
                    function s(t) {
                        ...
                        5 > o && (o = Math.max(-i, o / 2)), e.css(n.CSS.TRANSFORM, "translate3d(0," + (i + o) + "px,0)")
                    }
        ...
        function e(e, n, o, i) {
            ...
            function d(a, d, s) {
                n(d), e.attach(a, d), o.expectWithText(d, "aria-label"), r(s) && t.isDefined(s.ngDisabled) && a.$watch(s.ngDisabled, function (e) {
        ...
        function e(e, n, o, i, r, a) {
            function d(d, c) {
                var l = d.children(), m = c.hasOwnProperty("mdIndeterminate");
                return c.type = "checkbox", c.tabindex = c.tabindex || "0", d.attr("role", c.type), d.on("click", function (e) {
                    ...
                    function p(e) {
                        ...
                        t !== o.KEY_CODE.SPACE && t !== o.KEY_CODE.ENTER || (e.preventDefault(), c.hasClass("md-focused") || c.addClass("md-focused"), f(e))
                    }

                    function f(e) {
                        c[0].hasAttribute("disabled") || d.$apply(function () {
                    ...
                    function g() {
                        u.$viewValue && !E ? c.addClass(s) : c.removeClass(s)
                    }

                    function b(e) {
                        E = e !== !1, E && c.attr("aria-checked", "mixed"), c.toggleClass("md-indeterminate", E)
                    }

                    var E;
                    u = u || r.fakeNgModel(), i(c), m && (b(), d.$watch(l.mdIndeterminate, b)), l.ngChecked && d.$watch(d.$eval.bind(d, l.ngChecked), u.$setViewValue.bind(u)), h("ngDisabled", "tabindex", {
                        "true": "-1",
                        "false": l.tabindex
                    }), n.expectWithText(c, "aria-label"), e.link.pre(d, {
                        on: t.noop,
                        0: {}
                    }, l, [u]), d.mouseActive = !1, c.on("click", f).on("keypress", p).on("mousedown", function () {
                        d.mouseActive = !0, a(function () {
                            d.mouseActive = !1
                        }, 100)
                    }).on("focus", function () {
                        d.mouseActive === !1 && c.addClass("md-focused")
                    }).on("blur", function () {
        ...
        function e(e) {
            ...
            return {
                restrict: "E", controller: ["$scope", "$element", t], link: function (t, o, i) {
                    o[0];
        ...
        !function () {
            ...
            var o = 265, i = 45, r = "md-calendar-selected-date", a = "md-focus", d = 0;
            n.$inject = ["$element", "$attrs", "$scope", "$animate", "$q", "$mdConstant", "$mdTheming", "$$mdDateUtil", "$mdDateLocale", "$mdInkRipple", "$mdUtil"], n.prototype.configureNgModel = function (e) {
                ...
                var e = this.$element[0], t = e.querySelector(".md-calendar-scroll-mask"), n = this.calendarScroller,
                    o = e.querySelector(".md-calendar-day-header").clientWidth, i = n.offsetWidth - n.clientWidth;
                t.style.width = o + "px", n.style.width = o + i + "px", n.style.paddingRight = i + "px"
                ...
                var o = this.getDateId(t), i = document.getElementById(o);
                ...
                this.selectedDate = e, this.changeDisplayDate(e).then(function () {
                    if (n) {
                        ...
                        o && (o.classList.remove(r), o.setAttribute("aria-selected", "false"))
                    }
                    if (e) {
                        var i = document.getElementById(t.getDateId(e));
                        i && (i.classList.add(r), i.setAttribute("aria-selected", "true"))
                    }
                })
        ...
        !function () {
            function e() {
                return {
                    ...
                    link: function (e, t, n, o) {
                        var i = o[0], r = o[1];
                        r.calendarCtrl = i, r.generateContent(), e.$watch(function () {
                            return r.offset
                        }, function (e, t) {
                            e != t && r.generateContent()
                        })
                    }
                }
            }
            ...
            var o = "md-calendar-date-today", i = "md-calendar-selected-date", r = "md-focus";
            n.$inject = ["$element", "$$mdDateUtil", "$mdDateLocale"], n.prototype.generateContent = function () {
                ...
                this.$element.empty(), this.$element.append(this.buildCalendarForMonth(t)), this.focusAfterAppend && (this.focusAfterAppend.classList.add(r), this.focusAfterAppend.focus(), this.focusAfterAppend = null)
                ...
                if (n.tabIndex = -1, n.classList.add("md-calendar-date"), n.setAttribute("role", "gridcell"), e) {
                    n.setAttribute("tabindex", "-1"), n.setAttribute("aria-label", this.dateLocale.longDateFormatter(e)), n.id = t.getDateId(e), n.setAttribute("data-timestamp", e.getTime()), this.dateUtil.isSameDay(e, t.today) && n.classList.add(o), this.dateUtil.isValidDate(t.selectedDate) && this.dateUtil.isSameDay(e, t.selectedDate) && (n.classList.add(i), n.setAttribute("aria-selected", "true"));
                    var r = this.dateLocale.dates[e.getDate()];
                    if (this.isDateEnabled(e)) {
                        var a = document.createElement("span");
                        n.appendChild(a), a.classList.add("md-calendar-date-selection-indicator"), a.textContent = r, n.addEventListener("click", t.cellClickHandler), t.focusDate && this.dateUtil.isSameDay(e, t.focusDate) && (this.focusAfterAppend = n)
                    } else n.classList.add("md-calendar-date-disabled"), n.textContent = r
                }
                return n
                ...
                var t = this.dateUtil.isValidDate(e) ? e : new Date, n = this.dateUtil.getFirstDateOfMonth(t),
                    o = this.getLocaleDay_(n), i = this.dateUtil.getNumberOfDaysInMonth(t),
                    r = document.createDocumentFragment(), a = 1, d = this.buildDateRow(a);
                r.appendChild(d);
                var s = this.offset === this.calendarCtrl.items.length - 1, c = 0, l = document.createElement("td");
                if (l.classList.add("md-calendar-month-label"), this.calendarCtrl.maxDate && n > this.calendarCtrl.maxDate && l.classList.add("md-calendar-month-label-disabled"), l.textContent = this.dateLocale.monthHeaderFormatter(t), 2 >= o) {
                    ...
                    if (m.appendChild(l), r.insertBefore(m, d), s) return r
                } else c = 2, l.setAttribute("colspan", "2"), d.appendChild(l);
                for (var u = c; o > u; u++) d.appendChild(this.buildDateCell());
                for (var h = o, p = n, f = 1; i >= f; f++) {
                    if (7 === h) {
                        if (s) return r;
        ...
        !function () {
            ...
            function o(e, n, o, i, r, a, d, s, c, l, m, u) {
            ...
            var i = 3, r = "md-datepicker-invalid", a = 500, d = 368, s = 360;
            o.$inject = ["$scope", "$element", "$attrs", "$compile", "$timeout", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF"], o.prototype.configureNgModel = function (e) {
                ...
                if (this.clearErrorState(), this.dateUtil.isValidDate(n)) {
                    ...
                    if (this.dateUtil.isValidDate(this.maxDate)) {
                        ...
                        this.ngModelCtrl.$setValidity("maxdate", i >= n)
                    }
                ...
                var t = this.inputContainer.getBoundingClientRect(), n = document.body.getBoundingClientRect(),
                    o = t.top - n.top, i = t.left - n.left,
                    r = n.top < 0 && 0 == document.body.scrollTop ? -n.top : document.body.scrollTop,
                    a = n.left < 0 && 0 == document.body.scrollLeft ? -n.left : document.body.scrollLeft,
                    c = r + this.$window.innerHeight, l = a + this.$window.innerWidth;
                if (i + s > l) {
                    if (l - s > 0) i = l - s; else {
                        i = a;
                        var m = this.$window.innerWidth / s;
                        e.style.transform = "scale(" + m + ")"
                    }
                    e.classList.add("md-datepicker-pos-adjusted")
                }
                o + d > c && c - d > r && (o = c - d, e.classList.add("md-datepicker-pos-adjusted")), e.style.left = i + "px", e.style.top = o + "px", document.body.appendChild(e), this.inputMask.style.left = t.width + "px", this.$$rAF(function () {
        ...
        function e(e, n, o) {
            return {
                restrict: "E", link: function (i, r, a) {
                    n(r), e(function () {
                        function e() {
        ...
        function o(e) {
            ...
            function i(e, o, i, d, s, c, l, m, u, h) {
                function p(e, t, n, o) {
                    if (o) {
                        if (o.mdHtmlContent = o.htmlContent || n.htmlContent || "", o.mdTextContent = o.textContent || n.textContent || o.content || n.content || "", o.mdHtmlContent && !h.has("$sanitize")) throw Error("The ngSanitize module must be loaded in order to use htmlContent.");
                ...
                function f(e, n, o, r) {
                    ...
                    return t.element(c[0].body).addClass("md-dialog-is-showing"), b(o), $(n.find("md-dialog"), o), v(e, n, o), C(n, o).then(function () {
                        E(n, o), M(n, o), a(), d()
                    })
                }
                ...
                function g(e, n, o) {
                    ...
                    function d() {
                        t.element(c[0].body).removeClass("md-dialog-is-showing"), n.remove(), o.$destroy || o.origin.focus()
                    }
                ...
                function b(e) {
                    ...
                    function i(e, n) {
                        if (t.isString(e)) {
                            var o = e, i = c[0].querySelectorAll(o);
                            e = i.length ? i[0] : null
                        }
                ...
                function E(n, o) {
                    ...
                    if (r.on("resize", a), s.push(function () {
                        ...
                        var h, p = n, f = function (e) {
                            h = e.target
                        }, g = function (e) {
                            h === p[0] && e.target === p[0] && (e.stopPropagation(), e.preventDefault(), c())
                        };
                        p.on("mousedown", f), p.on("mouseup", g), s.push(function () {
                            p.off("mousedown", f), p.off("mouseup", g)
                        })
                    }
                ...
                function $(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog", d = e.find("md-dialog-content"),
                        s = e.attr("id"), c = "dialogContent_" + (s || i.nextUid());
                    e.attr({
                        role: n,
                        tabIndex: "-1"
                ...
                function M(e, t) {
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var t = e.parentNode.children, i = 0; i < t.length; i++) e === t[i] || T(t[i], ["SCRIPT", "STYLE"]) || t[i].setAttribute("aria-hidden", o);
                            n(e = e.parentNode)
                        }
                    }
                ...
                function y(e, t) {
                    ...
                    return e.css({top: (n ? i.scrollTop(t.parent) : 0) + "px", height: r ? r + "px" : "100%"}), e
                }

                function C(e, t) {
                    t.parent.append(e), y(e, t);
                    var n = e.find("md-dialog"), o = i.dom.animator, r = o.calculateZoomToOrigin,
                    ...
                    return t.fullscreen && n.addClass("md-dialog-fullscreen"), o.translate3d(n, d, s, a).then(function (e) {
                        return t.reverseAnimate = function () {
                            ...
                            }, d = s, s = o.toTransformCss(r(n, t.closeTo)), o.translate3d(n, d, s, a)) : e(o.toTransformCss(r(n, t.origin)))
                        }, !0
                    })
                }
            ...
            var r, a;
            return o.$inject = ["$mdDialog", "$mdTheming", "$mdConstant"], i.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector"], e("$mdDialog").setDefaults({
            ...
            function e() {
                return {
                    restrict: "E", require: ["^?mdFabSpeedDial", "^?mdFabToolbar"], compile: function (e, n) {
                        var o = e.children(), i = !1;
                        t.forEach(["", "data-", "x-"], function (e) {
                            i = i || !!o.attr(e + "ng-repeat")
        ...
        !function () {
            function e(e, n, o, i, r, a) {
                ...
                function M(e) {
                    "left" === N.direction ? E(e) : b(e)
                }

                function y(e) {
                    "down" === N.direction ? b(e) : E(e)
                }

                function C(e) {
                    "left" === N.direction ? b(e) : E(e)
                }

                function A(e) {
                    "up" === N.direction ? b(e) : E(e)
                }
                ...
                function k(e) {
                    T(e.target) && N.toggle(), w(e.target) && N.close()
                }
        ...
        !function () {
            ...
            function o(n) {
                ...
                function i(n) {
                    if (!n.hasClass("md-animations-waiting") || n.hasClass("md-animations-ready")) {
                        var o = n[0], i = n.controller("mdFabSpeedDial"), r = o.querySelectorAll(".md-fab-action-item"),
                            a = o.querySelector("md-fab-trigger"), d = o.querySelector(".md-css-variables"),
                        ...
                        t.forEach(r, function (e, t) {
                            ...
                            var n, o, r = e.style, d = (a.clientHeight - e.clientHeight) / 2,
            ...
            function i(n) {
                ...
                function i(n) {
                    var o = n[0], i = n.controller("mdFabSpeedDial"), r = o.querySelectorAll(".md-fab-action-item"),
                        d = o.querySelector(".md-css-variables"), s = parseInt(e.getComputedStyle(d).zIndex);
                    t.forEach(r, function (e, t) {
                        var n = e.style, o = t * a;
        ...
        !function () {
            ...
            function o() {
                function n(n, o, i) {
                    if (o) {
                        var r = n[0], a = n.controller("mdFabToolbar"),
                            d = r.querySelector(".md-fab-toolbar-background"),
                            s = r.querySelector("md-fab-trigger button"), c = r.querySelector("md-toolbar"),
                            l = r.querySelector("md-fab-trigger button md-icon"),
                            m = n.find("md-fab-actions").children();
                        if (s && d) {
                            var u = e.getComputedStyle(s).getPropertyValue("background-color"), h = r.offsetWidth,
                                p = (r.offsetHeight, 2 * (h / s.offsetWidth));
                            d.style.backgroundColor = u, d.style.borderRadius = h + "px", a.isOpen ? (c.style.pointerEvents = "initial", d.style.width = s.offsetWidth + "px", d.style.height = s.offsetHeight + "px", d.style.transform = "scale(" + p + ")", d.style.transitionDelay = "0ms", l && (l.style.transitionDelay = ".3s"), t.forEach(m, function (e, t) {
        ...
        function e(e, o, i, r) {
            function a(n, a, d, s) {
                function c() {
                    for (var e in o.MEDIA) r(e), r.getQuery(o.MEDIA[e]).addListener(C);
                    return r.watchResponsiveAttributes(["md-cols", "md-row-height", "md-gutter"], d, m)
                }

                function l() {
                    s.layoutDelegate = t.noop, A();
                    for (var e in o.MEDIA) r.getQuery(o.MEDIA[e]).removeListener(C)
                }
                ...
                function u(e) {
                    var o = g(), r = {tileSpans: b(o), colCount: E(), rowMode: M(), rowHeight: $(), gutter: v()};
                    if (e || !t.equals(r, T)) {
                            ...
                            return {
                                ...
                                tiles: e.map(function (e, i) {
                                    return {
                                        ...
                                        style: p(e.position, e.spans, r.colCount, n, r.gutter, r.rowMode, r.rowHeight)
                                    }
                                })
                            }
                        }).reflow().performance();
                        n.mdOnLayout({$event: {performance: d}}), T = r
                    }
                }
                ...
                function p(e, t, n, o, i, r, a) {
                    var d = 1 / n * 100, s = (n - 1) / n, c = _({share: d, gutterShare: s, gutter: i}), l = {
                        left: x({unit: c, offset: e.col, gutter: i}),
                        width: N({unit: c, span: t.col, gutter: i}),
                        paddingTop: "",
                        marginTop: "",
                        top: "",
                        height: ""
                    ...
                    switch (r) {
                        case"fixed":
                            l.top = x({unit: a, offset: e.row, gutter: i}), l.height = N({
                                unit: a,
                                span: t.row,
                                gutter: i
                            });
                        ...
                        case"ratio":
                            ...
                            l.paddingTop = N({unit: u, span: t.row, gutter: i}), l.marginTop = x({
                                unit: u,
                                offset: e.row,
                                gutter: i
                            });
                            break;
                        case"fit":
                            var h = (o - 1) / o, m = 1 / o * 100, u = _({share: m, gutterShare: h, gutter: i});
                            l.top = x({unit: u, offset: e.row, gutter: i}), l.height = N({
                                unit: u,
                                span: t.row,
                                gutter: i
                            })
                ...
                function f(e, t, n, o, i) {
                    ...
                    switch (o) {
                        case"fixed":
                            r.height = N({unit: i, span: t, gutter: n}), r.paddingBottom = "";
                            break;
                        case"ratio":
                            var a = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, s = d * (1 / i),
                                c = _({share: s, gutterShare: a, gutter: n});
                            r.height = "", r.paddingBottom = N({unit: c, span: t, gutter: n});
                            break;
                        case"fit":
                    }
                    return r
                ...
                a.attr("role", "list"), s.layoutDelegate = u;
                var C = t.bind(s, s.invalidateLayout), A = c();
                n.$on("$destroy", l);
                var T, w = e.startSymbol(), k = e.endSymbol(),
                    _ = e(h("share") + "% - (" + h("gutter") + " * " + h("gutterShare") + ")"),
                    x = e("calc((" + h("unit") + " + " + h("gutter") + ") * " + h("offset") + ")"),
                    N = e("calc((" + h("unit") + ") * " + h("span") + " + (" + h("span") + " - 1) * " + h("gutter") + ")")
            }
        ...
        function o(e) {
            ...
            function i(e, t) {
                function n(t, n) {
                    ...
                    for (var a = 0, l = 0; l - a < t.col;) d >= e ? o() : (a = c.indexOf(0, d), -1 !== a && -1 !== (l = r(a + 1)) ? d = l + 1 : (a = l = 0, o()));
                ...
                function i(e, t, n) {
                    for (var o = e; e + t > o; o++) c[o] = Math.max(c[o] + n, 0)
                }

                function r(e) {
                    var t;
                    for (t = e; t < c.length; t++) if (0 !== c[t]) return t;
                    return t === c.length ? t : void 0
                }
        ...
        function i(e, n, o) {
            function i(i, r, a, d) {
                ...
                function c() {
                    m.setHasValue(r.val().length > 0 || (r[0].validity || {}).badInput)
                }
                ...
                function l() {
                    ...
                    function a() {
                        if (l.style.height = l.offsetHeight + "px", r.addClass("md-no-flex"), isNaN(u)) {
                            c.style.height = "auto", c.scrollTop = 0;
                            var e = d();
                            e && (c.style.height = e + "px")
                        } else {
                            c.setAttribute("rows", 1), p || (c.style.minHeight = "0", p = r.prop("clientHeight"), c.style.minHeight = null);
                            var t = Math.min(u, Math.round(c.scrollHeight / p));
                            c.setAttribute("rows", t), c.style.height = p * t + "px"
                        }
                        r.removeClass("md-no-flex"), l.style.height = "auto"
                    }
                    ...
                    function s(e) {
                        c.scrollTop = 0;
                        var t = c.scrollHeight - c.offsetHeight, n = c.offsetHeight + t;
                        c.style.height = n + "px"
                    }

                    if (!t.isDefined(r.attr("md-no-autogrow"))) {
                        var c = r[0], l = m.element[0], u = NaN, p = null;
                        c.hasAttribute("rows") && (u = parseInt(c.getAttribute("rows")));
                        var f = e.debounce(a, 1);
                        if (h ? (h.$formatters.push(o), h.$viewChangeListeners.push(o)) : f(), r.on("keydown input", f), isNaN(u) && (r.attr("rows", "1"), r.on("scroll", s)), t.element(n).on("resize", f), i.$on("$destroy", function () {
                            t.element(n).off("resize", f)
                        }), t.isDefined(r.attr("md-detect-hidden"))) {
                            var g = function () {
                                var e = !1;
                                return function () {
                ...
                if (m) {
                    if ("hidden" === a.type) return void r.attr("aria-hidden", "true");
                    ...
                    r.after(f), m.label || o.expect(r, "aria-label", r.attr("placeholder")), r.addClass("md-input"), r.attr("id") || r.attr("id", "input_" + e.nextUid()), "textarea" === r[0].tagName.toLowerCase() && l(), u || c();
                    var g = m.isErrorGetter || function () {
                        return h.$invalid && (h.$touched || b())
                    }, b = function () {
                        var n = e.getClosest(r, "form"), o = n ? t.element(n).controller("form") : null;
                        return o ? o.$submitted : !1
                    };
                    i.$watch(g, m.setInvalid), h.$parsers.push(s), h.$formatters.push(s), r.on("input", c), p || r.on("focus", function (t) {
                        e.nextTick(function () {
                            m.setFocused(!0)
                        })
                    }).on("blur", function (t) {
            ...
            function o(o, i, r, a) {
                ...
                n.nextTick(function () {
                    l = t.element(u.element[0].querySelector(".md-errors-spacer")), c = t.element('<div class="md-char-counter">'), l.append(c), r.$set("ngTrim", "false"), m.$formatters.push(d), m.$viewChangeListeners.push(d), i.on("input keydown keyup", function () {
                        ...
                        return !t.isNumber(s) || 0 > s ? !0 : (e || i.val() || n || "").length <= s
                    }
                })
            }
        ...
        function a(e) {
            function n(e, n, o, i) {
                if (i) {
                    var r = i.element.find("label"), a = t.isDefined(i.element.attr("md-no-float"));
                    if (r && r.length || a) return void i.setHasPlaceholder(!0);
                    var d = o.placeholder;
                    if (n.removeAttr("placeholder"), i.input && "MD-SELECT" != i.input[0].nodeName) {
                        var s = '<label ng-click="delegateClick()">' + d + "</label>";
                        i.element.addClass("md-icon-float"), i.element.prepend(s)
                    }
                }
            }
        ...
        function l(e, t) {
            return {
                addClass: function (n, o, i) {
                    var r = E(n);
                    "md-input-invalid" == o && r.hasClass("md-auto-hide") ? h(n, t, e)["finally"](i) : i()
                }
            }
        }
        ...
        function m(e, t) {
            return {
                enter: function (n, o) {
                    ...
                    "ng-hide" == o ? p(n, t, e)["finally"](i) : i()
                }, removeClass: function (n, o, i) {
                    "ng-hide" == o ? h(n, t, e)["finally"](i) : i()
                }
            }
        }
        ...
        function h(e, n, o) {
            ...
            return t.forEach(a.children(), function (e) {
                i = f(t.element(e), n), r.push(i.start())
            }), o.all(r)
        }
        ...
        function p(e, n, o) {
            var i, r = [], a = E(e);
            return t.forEach(a.children(), function (e) {
                i = g(t.element(e), n), r.push(i.start())
            }), o.all(r)
        }
        ...
        function g(t, n) {
            var o = t[0].offsetHeight, i = e.getComputedStyle(t[0]);
            return 0 == i.opacity ? n(t, {}) : n(t, {
                event: "leave",
                structural: !0,
        ...
        function n(e, n, o, i) {
            ...
            return {
                restrict: "E", controller: "MdListController", compile: function (a, d) {
                    ...
                    function l() {
                        if (b && !h(b) && b.hasAttribute("ng-click")) {
                    ...
                    function p(e, a, d, s) {
                        ...
                        function m() {
                            (1 == u.length || p) && (a.addClass("md-clickable"), p || s.attachRipple(e, t.element(a[0].querySelector(".md-no-style"))))
                        }

                        var u = [], h = a[0].firstElementChild, p = h && c(h);
                        ...
                        p || u.length || h && h.addEventListener("keypress", f), a.off("click"), a.off("keypress"), 1 == u.length && h && a.children().eq(0).on("click", function (e) {
                            ...
                            h && h.removeEventListener("keypress", f)
                        })
                    }

                    var f, g, b = a[0].querySelector(".md-secondary");
                    if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref) c("button"); else {
                        for (var E, v = 0; E = r[v]; ++v) if (g = a[0].querySelector(E)) {
                            f = !0;
                            break
                        }
                        f ? c("div") : a[0].querySelector("md-button:not(.md-secondary):not(.md-exclude)") || a.addClass("md-no-proxy")
                    }
                    return l(), s(), p
                }
            }
        ...
        function o(e, t) {
            this._$q = t.get("$q"), this._$mdCompiler = t.get("$mdCompiler"), this._$mdConstant = t.get("$mdConstant"), this._$mdUtil = t.get("$mdUtil"), this._$rootScope = t.get("$rootScope"), this._$animate = t.get("$animate"), this._$mdPanel = t.get("$mdPanel"), this._$log = t.get("$log"), this._$window = t.get("$window"), this._$$rAF = t.get("$$rAF"), this.id = e.id, this.isAttached = !1, this._config = e, this._panelContainer, this._panelEl, this._removeListeners = [], this._topFocusTrap, this._bottomFocusTrap, this._backdropRef, this._restoreScroll = null
        }

        function i(e) {
            this._$window = e, this._absolute = !1, this._relativeToEl, this._top = "", this._bottom = "", this._left = "", this._right = "", this._translateX = [], this._translateY = [], this._positions = [], this._actualPosition
        }
        ...
        e.$inject = ["$rootElement", "$rootScope", "$injector", "$window"], e.prototype.create = function (e) {
            ...
            return this._$q(function (n, o) {
                var i = e._done(n, e), r = e._config.onDomAdded || t.noop, a = function (t) {
            ...
            var e = this, n = e._config.onDomRemoved || t.noop, o = function () {
            ...
            return this._restoreScroll && (this._restoreScroll(), this._restoreScroll = null), this._$q(function (t, i) {
                var r = e._done(t, e);
                e._$q.all([o(), e._backdropRef ? e._backdropRef.detach() : !0]).then(n).then(r)["catch"](i)
            })
            ...
            return this._$q(function (o, i) {
                var r = e._done(o, e), a = e._config.onOpenComplete || t.noop;
            ...
            var e = this;
            return this._$q(function (n, o) {
                var i = e._done(n, e), r = e._config.onRemoving || t.noop, d = function () {
                    var t = e._config.origin;
                    t && a(t).focus()
                }, c = function () {
                    e.addClass(s)
                };
            ...
            this._panelContainer.hasClass(e) || this._panelContainer.addClass(e)
        }, o.prototype.removeClass = function (e) {
            if (!this._panelContainer) throw new Error("Panel does not exist yet. Call open() or attach().");
            this._panelContainer.hasClass(e) && this._panelContainer.removeClass(e)
            ...
            var e = this;
            return this._$q(function (n, o) {
                e._config.locals || (e._config.locals = {}), e._config.locals.mdPanelRef = e, e._$mdCompiler.compile(e._config).then(function (i) {
                    e._panelContainer = i.link(e._config.scope), a(e._config.attachTo).append(e._panelContainer), e._config.disableParentScroll && (e._restoreScroll = e._$mdUtil.disableScrollAround(null, e._panelContainer)), e._panelEl = t.element(e._panelContainer[0].querySelector(".md-panel")), e._config.panelClass && e._panelEl.addClass(e._config.panelClass), e._$animate.pin && e._$animate.pin(e._panelContainer, a(e._config.attachTo)), e._configureTrapFocus(), e._addStyles().then(function () {
                        n(e)
                    }, o)
                }, o)
            })
            ...
            return this._$q(function (t) {
                e._panelContainer.css("z-index", e._config.zIndex), e._panelEl.css("z-index", e._config.zIndex + 1);
                var n = function () {
                    e._panelEl.css("left", ""), e._panelContainer.addClass(s), t(e)
                };
                if (e._config.fullscreen) return e._panelEl.addClass("_md-panel-fullscreen"), void n();
                var o = e._config.position;
                return o ? void e._$rootScope.$$postDigest(function () {
                    e._updatePosition(!0), t(e)
                }) : void n()
            })
        }, o.prototype._updatePosition = function (e) {
            var t = this._config.position;
            if (t) {
            ...
            if (this._config.hasBackdrop) {
                if (!this._backdropRef) {
                    var e = this._$mdPanel.newPanelAnimation().openFrom(this._config.attachTo).withAnimation({
            ...
            if (this._config.escapeToClose) {
                var e = a(this._config.attachTo), t = this, n = function (e) {
            ...
            var e = t.bind(this, this._updatePosition), n = this._$$rAF.throttle(e), o = this, i = function () {
                o._config.disableParentScroll || n()
            };
            ...
            if (this._panelEl.attr("tabIndex", "-1"), this._config.trapFocus) {
                var e = this._panelEl;
            ...
            return this._bottom = "", this._top = e || "0", this
        }, i.prototype.bottom = function (e) {
            return this._top = "", this._bottom = e || "0", this
        }, i.prototype.left = function (e) {
            return this._right = "", this._left = e || "0", this
        }, i.prototype.right = function (e) {
            return this._left = "", this._right = e || "0", this
            ...
            var t = parseInt(this.getLeft()), n = parseInt(this.getTop()), o = t + e[0].offsetWidth,
            ...
            var n = e[0].getBoundingClientRect(), o = n.width, r = n.height,
                a = this._relativeToEl[0].getBoundingClientRect(), d = a.left, s = a.right, c = a.width;
            switch (t.x) {
            ...
            var m = a.top, u = a.bottom, h = a.height;
            switch (t.y) {
            ...
            var n = this._$mdUtil.dom.animator, o = {}, i = e[0].style.transform || "", a = n.toTransformCss(i),
            ...
            return e instanceof t.element ? {element: e, bounds: e[0].getBoundingClientRect()} : void 0
        }
    }(), function () {
        function e(e, o, i) {
            function r(e) {
            ...
            function a(r, a, h) {
                function p() {
                    h.$observe("value", function (e) {
                        ...
                        switch (e) {
                            case m:
                            case u:
                                y.removeClass("ng-hide"), $ && y.removeClass($), y.addClass($ = "md-mode-" + e);
                                break;
                            default:
                                $ && y.removeClass($), y.addClass("ng-hide"), $ = n
                        }
                    })
                }
                ...
                function f() {
                    M.css({
                        width: 100 * E() + "px",
                        height: 100 * E() + "px"
                    }), M.children().eq(0).css(C({transform: o.supplant("translate(-50%, -50%) scale( {0} )", [E()])}))
                }

                function g() {
                    if (t.isUndefined(h.mdMode)) {
                        var e = t.isDefined(h.value), n = e ? m : u,
                            r = "Auto-adding the missing md-mode='{0}' to the ProgressCircular element";
                        i.debug(o.supplant(r, [n])), a.attr("md-mode", n), h.mdMode = n
                    }
                }
            ...
            var c = 100, l = .5, m = "determinate", u = "indeterminate";
            return {
                restrict: "E",
                scope: !0,
        ...
        function e(e, o, i) {
            ...
            function a(r, a, u) {
                function h() {
                    u.$observe("value", function (e) {
                        var t = d(e);
                        a.attr("aria-valuenow", t), f() != m && g($, t)
                        ...
                        switch (e) {
                            ...
                            case s:
                            case c:
                                M.removeClass("ng-hide " + b), M.addClass(b = "md-mode-" + e);
                                break;
                            default:
                                b && M.removeClass(b), M.addClass("ng-hide"), b = n
                        }
                    })
                }
                ...
                function p() {
                    if (t.isUndefined(u.mdMode)) {
                        var e = t.isDefined(u.value), n = e ? s : c,
                            r = "Auto-adding the missing md-mode='{0}' to the ProgressLinear element";
                        i.debug(o.supplant(r, [n])), a.attr("md-mode", n), u.mdMode = n
                    }
                }
                ...
                function g(e, n) {
                    if (f()) {
                        var i = o.supplant("translateX({0}%) scale({1},1)", [(n - 100) / 2, n / 100]),
                            r = E({transform: i});
                        t.element(e).css(r)
                    }
                }
                ...
                e(a);
                var b, E = o.dom.animator.toCss, v = t.element(a[0].querySelector(".md-bar1")),
                    $ = t.element(a[0].querySelector(".md-bar2")), M = t.element(a[0].querySelector(".md-container"));
            ...
            var s = "determinate", c = "indeterminate", l = "buffer", m = "query";
            return {
                restrict: "E",
            ...
            function s(n, o) {
                ...
                if (i.count()) {
                    var r = function (e) {
                        ...
                        d = i[0 > o ? "previous" : "next"](a, r) || i.first();
        ...
        function e(e, o, i, r, a, d) {
            function s(a, s) {
                ...
                if (c.append('<span class="md-select-icon" aria-hidden="true"></span>'), c.addClass("md-select-value"), c[0].hasAttribute("id") || c.attr("id", "select_value_label_" + o.nextUid()), a.find("md-content").length || a.append(t.element("<md-content>").append(a.contents())), s.mdOnOpen && (a.find("md-content").prepend(t.element('<div> <md-progress-circular md-mode="{{progressMode}}" ng-hide="$$loadingAsyncDone" md-diameter="25px"></md-progress-circular></div>')), a.find("md-option").attr("ng-show", "$$loadingAsyncDone")), s.name) {
                    ...
                    l.attr({name: "." + s.name, "ng-model": s.ngModel, "aria-hidden": "true", tabindex: "-1"});
                ...
                var u = t.isDefined(s.multiple) ? "multiple" : "",
                    h = '<div class="md-select-menu-container" aria-hidden="true"><md-select-menu {0}>{1}</md-select-menu></div>';
                return h = o.supplant(h, [u, a.html()]), a.empty().append(c), a.append(h), s.tabindex || s.$set("tabindex", 0), function (a, s, c, l) {
                    function m() {
                        var e = s.attr("aria-label") || s.attr("placeholder");
                        !e && M && M.label && (e = M.label.text()), v = e, r.expect(s, "aria-label", e)
                    }

                    function u() {
                        _ && (N = N || _.find("md-select-menu").controller("mdSelectMenu"), y.setLabelText(N.selectedLabels()))
                    }

                    function h() {
                        if (v) {
                            var e = N.selectedLabels({mode: "aria"});
                            s.attr("aria-label", e.length ? v + ": " + e : v)
                        }
                    }
                    ...
                    function f() {
                        if (_ = t.element(s[0].querySelector(".md-select-menu-container")), x = a, c.mdContainerClass) {
                            var e = _[0].getAttribute("class") + " " + c.mdContainerClass;
                            _[0].setAttribute("class", e)
                        }
                        N = _.find("md-select-menu").controller("mdSelectMenu"), N.init(C, c.ngModel), s.on("$destroy", function () {
                            _.remove()
                        })
                    }
                    ...
                    function g(e) {
                        ...
                        if (-1 != n.indexOf(e.keyCode)) e.preventDefault(), b(e); else if (e.keyCode <= 90 && e.keyCode >= 31) {
                            ...
                            if (!o) return;
                            var i = t.element(o).controller("mdOption");
                            N.isMultiple || N.deselect(Object.keys(N.selected)[0]), N.select(i.hashKey, i.value), N.refreshViewValue()
                        }
                    }

                    function b() {
                        x.isOpen = !0, s.attr("aria-expanded", "true"), e.show({
                            scope: x,
                            preserveScope: !0,
                            skipCompile: !0,
                            element: _,
                            ...
                            preserveElement: !0,
                            hasBackdrop: !0,
                            loadingAsync: c.mdOnOpen ? a.$eval(c.mdOnOpen) || !0 : !1
                        })["finally"](function () {
                            x.isOpen = !1, s.focus(), s.attr("aria-expanded", "false"), C.$setTouched()
                        })
                    }

                    var E, v, $ = !0, M = l[0], y = l[1], C = l[2], A = l[3], T = s.find("md-select-value"),
                        w = t.isDefined(c.readonly);
                    if (M) {
                        ...
                        M.input = s, M.label || r.expect(s, "aria-label", s.attr("placeholder")), a.$watch(k, M.setInvalid)
                    }
                    var _, x, N;
                    if (f(), i(s), c.name && A) {
                        var H = s.parent()[0].querySelector('select[name=".' + c.name + '"]');
                        o.nextTick(function () {
                            var e = t.element(H).controller("ngModel");
                            e && A.$removeControl(e)
                        })
                    }
                    A && t.isDefined(c.multiple) && o.nextTick(function () {
                    ...
                    C.$render = function () {
                        S(), u(), h(), p()
                    }, c.$observe("placeholder", C.$render), y.setLabelText = function (e) {
                        if (y.setIsPlaceholder(!e), c.mdSelectedText) e = d(c.mdSelectedText)(a); else {
                        ...
                        e ? (T.addClass("md-select-placeholder"), M && M.label && M.label.addClass("md-placeholder")) : (T.removeClass("md-select-placeholder"), M && M.label && M.label.removeClass("md-placeholder"))
                    }, w || (s.on("focus", function (e) {
                        M && M.element.hasClass("md-input-has-value") && M.setFocused(!0)
                    }), s.on("blur", function (e) {
                        $ && ($ = !1, x.isOpen && e.stopImmediatePropagation()), x.isOpen || (M && M.setFocused(!1), p())
                    })), y.triggerClose = function () {
                        d(c.mdOnClose)(a)
                    }, a.$$postDigest(function () {
                        m(), u(), h()
                    }), a.$watch(N.selectedLabels, u);
                    var D;
                    c.$observe("ngMultiple", function (e) {
                        ...
                        D = a.$watch(function () {
                            ...
                            e === n && t === n || (e ? s.attr("multiple", "multiple") : s.removeAttr("multiple"), s.attr("aria-multiselectable", e ? "true" : "false"), _ && (N.setMultiple(e), S = C.$render, C.$render = function () {
                                S(), u(), h(), p()
                            }, C.$render()))
                        })
                    }), c.$observe("disabled", function (e) {
                        t.isString(e) && (e = !0), E !== n && E === e || (E = e, e ? s.attr({"aria-disabled": "true"}).removeAttr("tabindex").off("click", b).off("keydown", g) : s.attr({
                            tabindex: c.tabindex,
                            "aria-disabled": "false"
                        }).on("click", b).on("keydown", g))
                    }), c.hasOwnProperty("disabled") || c.hasOwnProperty("ngDisabled") || (s.attr({"aria-disabled": "false"}), s.on("click", b), s.on("keydown", g));
                    var O = {
                        role: "listbox",
                        "aria-expanded": "false",
                        "aria-multiselectable": c.multiple === n || c.ngMultiple ? "false" : "true"
                    };
                    s[0].hasAttribute("id") || (O.id = "select_" + o.nextUid());
                    var I = "select_container_" + o.nextUid();
                    _.attr("id", I), O["aria-owns"] = I, s.attr(O), a.$on("$destroy", function () {
                        e.destroy()["finally"](function () {
                            M && (M.setFocused(!1), M.setHasValue(!1), M.input = null), C.$setTouched()
                        })
                    })
                }
            }
        ...
        function o(e, o, i) {
            function r(e, n, r, a) {
                ...
                var c = a[0];
                i(n), n.on("click", s), n.on("keypress", d)
            }
            ...
            function a(i, r, a) {
                function d() {
                    ...
                    if (t.isArray(e)) {
                        var n = Object.keys(l.selected), o = e.map(l.hashGetter), i = n.filter(function (e) {
                ...
                var l = this;
                l.isMultiple = t.isDefined(r.multiple), l.selected = {}, l.options = {}, i.$watchCollection(function () {
                    return l.options
                }, function () {
                    l.ngModel.$render()
                });
                ...
                l.setMultiple = function (e) {
                    ...
                    var o = l.ngModel;
                    u = u || o.$isEmpty, l.isMultiple = e, m && m(), l.isMultiple ? (o.$validators["md-multiple"] = n, o.$render = d, i.$watchCollection(l.modelBinding, function (e) {
                ...
                l.optNodeForKeyboardSearch = function (e) {
                    ...
                    for (var i = 0; i < f.length; ++i) if (o.test(f[i])) return p[i]
                }, l.init = function (n, o) {
                    if (l.ngModel = n, l.modelBinding = o, n.$options && n.$options.trackBy) {
                        var r = {}, a = e(n.$options.trackBy);
                        l.hashGetter = function (e, t) {
                            return r.$value = e, a(t || i, r)
                        }
                    ...
                    var i = l.ngModel.$options && l.ngModel.$options.trackBy, r = l.isMultiple ? n : n[0],
                        a = l.ngModel.$modelValue;
                    (i ? t.equals(a, r) : a == r) || (l.ngModel.$setViewValue(r), l.ngModel.$render())
                }
            }
        ...
        function i(e, n) {
            ...
            function i(o, i, r, a) {
                function d(e, t, n) {
                    ...
                    var i = m.hashGetter(t, o), r = m.hashGetter(e, o);
                    c.hashKey = r, c.value = e, m.removeOption(i, c), m.addOption(r, c)
                }
                ...
                var c = a[0], m = a[1];
                m.isMultiple && (i.addClass("md-checkbox-enabled"), i.prepend(l.clone())), t.isDefined(r.ngValue) ? o.$watch(r.ngValue, d) : t.isDefined(r.value) ? d(r.value) : o.$watch(function () {
                    return i.text().trim()
            ...
            function o(e, o, c, l, m, u, h, p, f) {
                ...
                function b(i, r, a) {
                    ...
                    function s() {
                        return m(function (e) {
                            ...
                            t.container.element.css(M.toCss(t.container.styles)), t.dropDown.element.css(M.toCss(t.dropDown.styles)), u(function () {
                                r.addClass("md-active"), t.dropDown.element.css(M.toCss({transform: ""})), b(a.focusedNode), e()
                            })
                        })
                    }

                    function g(e, t, n) {
                        return n.disableParentScroll && !c.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = c.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = c.createBackdrop(e, "md-select-backdrop md-click-catcher"), p.enter(n.backdrop, f[0].body, null, {duration: 0})), function () {
                    ...
                    function E(e, n) {
                        ...
                        if (!n.target) throw new Error(c.supplant($, [n.target]));
                        t.extend(n, {
                            isRemoved: !1,
                    ...
                    function y() {
                        var e = function (e, t, n) {
                            return function () {
                                if (!n.isRemoved) {
                                    var o = v(e, t, n), i = o.container, r = o.dropDown;
                    ...
                    function C() {
                        a.loadingAsync && !a.isRemoved && (i.$$loadingAsyncDone = !1, i.progressMode = "indeterminate", m.when(a.loadingAsync).then(function () {
                    ...
                    function A() {
                        ...
                        function i(t) {
                            ...
                            switch (t.preventDefault(), t.stopPropagation(), t.keyCode) {
                                ...
                                case n.ENTER:
                                    ...
                                    i && (u.triggerHandler({type: "click", target: i}), t.preventDefault()), m(t);
                                    break;
                                case n.TAB:
                                case n.ESCAPE:
                                ...
                                default:
                                    if (t.keyCode >= 31 && t.keyCode <= 90) {
                                        var r = u.controller("mdSelectMenu").optNodeForKeyboardSearch(t);
                                        a.focusedNode = r || a.focusedNode, r && r.focus()
                                    }
                            }
                        }
                        ...
                        function d(e) {
                            ...
                            do -1 === i ? i = 0 : "next" === e && i < o.length - 1 ? i++ : "prev" === e && i > 0 && i--, t = o[i], t.hasAttribute("disabled") && (t = n); while (!t && i < o.length - 1 && i > 0);
                        ...
                        function m(t) {
                            ...
                            if (!(t && "click" == t.type && t.currentTarget != u[0] || n())) {
                                ...
                                o && o.hasAttribute && !o.hasAttribute("disabled") && (t.preventDefault(), t.stopPropagation(), h.isMultiple || (a.restoreFocus = !0, c.nextTick(function () {
                        ...
                        if (!a.isRemoved) {
                            ...
                            return r.addClass("md-clickable"), a.backdrop && a.backdrop.on("click", t), u.on("keydown", i), u.on("click", m), function () {
                                a.backdrop && a.backdrop.off("click", t), u.off("keydown", i), u.off("click", m), r.removeClass("md-clickable"), a.isRemoved = !0
                            }
                        }
                    }

                    return C(), E(i, a), a.hideBackdrop = g(i, r, a), d(i, r, a).then(function (e) {
                        return r.attr("aria-hidden", "false"), a.alreadyOpen = !0, a.cleanupInteraction = A(), a.cleanupResizing = y(), e
                    }, a.hideBackdrop);
                }
                ...
                function v(e, n, o) {
                    var m, u = n[0], h = o.target[0].children[0], p = f[0].body, g = o.selectEl[0], b = o.contentEl[0],
                        E = p.getBoundingClientRect(), v = h.getBoundingClientRect(), $ = !1, M = {
                            left: E.left + s,
                            top: s,
                            bottom: E.height - s,
                            right: E.width - s - (c.floatingScrollbars() ? 16 : 0)
                        }, y = {
                            top: v.top - M.top,
                            left: v.left - M.left,
                            right: M.right - (v.left + v.width),
                            bottom: M.bottom - (v.top + v.height)
                        }, C = E.width - 2 * s, A = g.querySelector("md-option[selected]"),
                        T = g.getElementsByTagName("md-option"), w = g.getElementsByTagName("md-optgroup"), k = d(n, b),
                        _ = i(o.loadingAsync);
                    m = _ ? b.firstElementChild || b : A ? A : w.length ? w[0] : T.length ? T[0] : b.firstElementChild || b, b.offsetWidth > C ? b.style["max-width"] = C + "px" : b.style.maxWidth = null, $ && (b.style["min-width"] = v.width + "px"), k && g.classList.add("md-overflow");
                    var x = m;
                    "MD-OPTGROUP" === (x.tagName || "").toUpperCase() && (x = T[0] || b.firstElementChild || b, m = x), o.focusedNode = x, u.style.display = "block";
                    var N = g.getBoundingClientRect(), H = a(m);
                    if (m) {
                    ...
                    if (k) {
                        ...
                        b.scrollTop = H.top + H.height / 2 - D, y.top < D ? b.scrollTop = Math.min(H.top, b.scrollTop + D - y.top) : y.bottom < D && (b.scrollTop = Math.max(H.top + H.height - N.height, b.scrollTop - D + y.bottom))
                    }
                    var O, I, R, L;
                    $ ? (O = v.left, I = v.top + v.height, R = "50% 0", I + N.height > M.bottom && (I = v.top - N.height, R = "50% 100%")) : (O = v.left + H.left - H.paddingLeft + 2, I = Math.floor(v.top + v.height / 2 - H.height / 2 - H.top + b.scrollTop) + 2, R = H.left + v.width / 2 + "px " + (H.top + H.height / 2 - b.scrollTop) + "px 0px", L = Math.min(v.width + H.paddingLeft + H.paddingRight, C));
                    var P = u.getBoundingClientRect(), F = Math.round(100 * Math.min(v.width / N.width, 1)) / 100,
                        B = Math.round(100 * Math.min(v.height / N.height, 1)) / 100;
                    return {
                        container: {
                            element: t.element(u),
                            styles: {
                                left: Math.floor(r(M.left, O, M.right - P.width)),
                                top: Math.floor(r(M.top, I, M.bottom - P.height)),
                                "min-width": L
                            }
                        },
                        dropDown: {
                            ...
                            styles: {
                                transformOrigin: R,
                                transform: o.alreadyOpen ? "" : c.supplant("scale({0},{1})", [F, B])
                            }
                        }
                    }
                }
        ...
        var s = 8, c = 0, l = t.element('<div class="md-container"><div class="md-icon"></div></div>');
        ...
        function e(e, t) {
            return ["$mdUtil", function (n) {
                return {
                    restrict: "A", multiElement: !0, link: function (o, i, r) {
                        var a = o.$on("$md-resize-enable", function () {
                            a(), o.$watch(r[e], function (e) {
                                !!e === t && (n.nextTick(function () {
                                    o.$broadcast("$md-resize")
                                }), n.dom.animator.waitTransitionEnd(i).then(function () {
                                    o.$broadcast("$md-resize")
                                }))
                            })
                        })
        ...
        function e(e, n) {
            return function (o) {
                ...
                var r, a = "SideNav '" + o + "' is not available!", d = e.get(o);
                return d || e.notFoundError(o), r = {
                    isOpen: function () {
                        return d && d.isOpen()
        ...
        function i(e, o, i, r, a, d, s, c, l, m) {
            function u(d, u, h, p) {
                ...
                function g(e) {
                    ...
                    return n[e ? "on" : "off"]("keydown", v), w[e ? "on" : "off"]("click", $), e && (y = m[0].activeElement), b(e), C = l.all([e ? a.enter(w, n) : a.leave(w), a[e ? "removeClass" : "addClass"](u, "md-closed")]).then(function () {
                        d.isOpen && t && t.focus()
                    })
                }
                ...
                var M, y = null, C = l.when(!0), A = s(h.mdIsLockedOpen), T = function () {
                    return A(d.$parent, {
                        $media: function (t) {
                ...
                r(u), r.inherit(w, u), u.on("$destroy", function () {
                    w.remove(), p.destroy()
        ...
        function e(e, n, o, i, r, a, d, s, c) {
            ...
            function m(o, s, l, m) {
                ...
                function h(e) {
                    Y = parseFloat(e), s.attr("aria-valuemin", e), u()
                }

                function p(e) {
                    K = parseFloat(e), s.attr("aria-valuemax", e), u()
                }
                ...
                function b() {
                    if (t.isDefined(l.mdDiscrete) && !t.isUndefined(G)) {
                        ...
                        if (!X) {
                            ...
                            var i = n.getComputedStyle(j[0]);
                            Q = X[0].getContext("2d"), Q.fillStyle = i.backgroundColor || "black"
                        }
                        var r = v();
                        X[0].width = r.width, X[0].height = r.height;
                        for (var a, d = 0; o >= d; d++) a = Math.floor(r.width * (d / o)), Q.fillRect(a - 1, 0, 2, r.height)
                    }
                }

                function E() {
                    Z = q[0].getBoundingClientRect()
                }
                ...
                function $(e) {
                    if (!P) {
                        var t;
                        e.keyCode === r.KEY_CODE.LEFT_ARROW ? t = -G : e.keyCode === r.KEY_CODE.RIGHT_ARROW && (t = G), t && ((e.metaKey || e.ctrlKey || e.altKey) && (t *= 4), e.preventDefault(), e.stopPropagation(), o.$evalAsync(function () {
                            M(m.$viewValue + t)
                        }))
                    }
                }
                ...
                function y() {
                    ...
                    o.modelValue = m.$viewValue, s.attr("aria-valuenow", m.$viewValue), T(e), B.text(m.$viewValue)
                }
                ...
                function T(e) {
                    e = O(e);
                    var t = 100 * e + "%";
                    z.css("width", t), U.css("left", t), s.toggleClass("md-min", 0 === e), s.toggleClass("md-max", 1 === e)
                }

                function w(e) {
                    if (!P) {
                        s.addClass("md-active"), s[0].focus(), E();
                        var t = R(I(e.pointer.x)), n = C(A(t));
                        o.$apply(function () {
                            M(n), T(L(n))
                        })
                    }
                ...
                function _(e) {
                    P || (J = !0, e.stopPropagation(), s.addClass("md-dragging"), H(e))
                }
                ...
                l.$observe("disabled", function (e) {
                    P = i.parseAttributeBoolean(e, !1), g()
                });
                var F = t.element(s[0].querySelector(".md-thumb")), B = t.element(s[0].querySelector(".md-thumb-text")),
                    U = F.parent(), q = t.element(s[0].querySelector(".md-track-container")),
                    z = t.element(s[0].querySelector(".md-track-fill")),
                    j = t.element(s[0].querySelector(".md-track-ticks")), V = i.throttle(E, 5e3);
                t.isDefined(l.min) ? l.$observe("min", h) : h(0), t.isDefined(l.max) ? l.$observe("max", p) : p(100), t.isDefined(l.step) ? l.$observe("step", f) : f(1), d.register(s, "drag"), s.on("keydown", $).on("$md.pressdown", w).on("$md.pressup", k).on("$md.dragstart", _).on("$md.drag", x).on("$md.dragend", N), setTimeout(u, 0);
                var W = e.throttle(u);
                ...
                var Y, K, G, X, Q, Z = {};
                E();
                var J = !1, ee = t.isDefined(l.mdDiscrete)
            }
        ...
        function e(e, o, i, r, a) {
            function d(e) {
                function t(e, t) {
                    t.addClass("md-sticky-clone");
                    var n = {element: e, clone: t};
                    return f.items.push(n), r.nextTick(function () {
                        h.prepend(n.clone)
                    }), p(), function () {
                ...
                function d(e) {
                    var t = e.element[0];
                    for (e.top = 0, e.left = 0; t && t !== h[0];) e.top += t.offsetTop, e.left += t.offsetLeft, t.offsetParent && (e.right += t.offsetParent.offsetWidth - t.offsetWidth - t.offsetLeft), t = t.offsetParent;
                    e.height = e.element.prop("offsetHeight"), e.clone.css("margin-left", e.left + "px"), r.floatingScrollbars() && e.clone.css("margin-right", "0")
                }
                ...
                var h = e.$element, p = i.throttle(a);
            ...
            function s(n) {
                var o, i = t.element("<div>");
                e[0].body.appendChild(i[0]);
                for (var r = ["sticky", "-webkit-sticky"], a = 0; a < r.length; ++a) if (i.css({
                    position: r[a],
                    top: 0,
                    "z-index": 2
                }), i.css("position") == r[a]) {
            ...
            function c(e) {
                function t() {
                    +r.now() - o > a ? (n = !1, e.triggerHandler("$scrollend")) : (e.triggerHandler("$scroll"), i.throttle(t))
                }

                var n, o, a = 200;
                e.on("scroll touchmove", function () {
                    n || (n = !0, i.throttle(t), e.triggerHandler("$scrollstart")), e.triggerHandler("$scroll"), o = +r.now()
                })
            }
            ...
            return function (e, t, n) {
                ...
                if (o) if (l) t.css({position: l, top: 0, "z-index": 2}); else {
                    ...
                    i || (i = d(o), o.$element.data("$$sticky", i));
                    var r = n || a(t.clone())(e), s = i.add(t, r);
                    e.$on("$destroy", s)
                }
            }
        }
            ...
            return {
                ...
                link: function (r, a, d, s, c) {
                    ...
                    c(r, function (e) {
                        ...
                        var o = '<div class="md-subheader-wrapper">' + m + "</div>", d = n(o)(r);
                        e(r, a, d), i.nextTick(function () {
                            l(d).append(t)
                        })
                    })
                }
        ...
        function e(e, n, o, i, r, a) {
            function d(e, d) {
                var c = s.compile(e, d);
                return e.addClass("md-dragging"), function (e, d, s, l) {
                    function m(t) {
            ...
            function o(e, n, o, r) {
                function a(t, a, d) {
                    ...
                    return a = o.extractElementByName(a, "md-toast", !0), d.element = a, d.onSwipe = function (e, t) {
                        ...
                        "down" === r && -1 != d.position.indexOf("top") && !l || "up" === r && (-1 != d.position.indexOf("bottom") || l) || ("left" !== r && "right" !== r || !l) && (a.addClass("md-" + i), o.nextTick(n.cancel))
                    }, d.openClass = s(d.position), d.parent.addClass(d.openClass), o.hasComputedStyle(d.parent, "position", "static") && d.parent.css("position", "relative"), a.on(c, d.onSwipe), a.addClass(l ? "md-bottom" : d.position.split(" ").map(function (e) {
                        return "md-" + e
                ...
                function s(e) {
                    return r("gt-sm") ? "md-toast-open-" + (e.indexOf("top") > -1 ? "top" : "bottom") : "md-toast-open-bottom"
                }
                    ...
                    transformTemplate: function (e, n) {
                        ...
                        if (o) {
                            ...
                            for (var r = 0; r < i.children.length; r++) if ("MD-TOAST" === i.children[r].nodeName) {
                                ...
                                a.append(i.children[r].children), i.children[r].appendChild(a[0])
                            }
                            return i.outerHTML
                        }
                        return e || ""
                ...
                template: "", restrict: "E", link: function (d, s, c) {
                    function l() {
                        ...
                        function m(e) {
                            ...
                            M(), b = Math.min(p / v, Math.max(0, b + t - E)), s.css(n.CSS.TRANSFORM, a([-b * v])), f.css(n.CSS.TRANSFORM, a([(p - b) * v])), E = t, o.nextTick(function () {
                        ...
                        function u() {
                            return f ? (f.on("scroll", $), f.attr("scroll-shrink", "true"), e(h), function () {
                                f.off("scroll", $), f.attr("scroll-shrink", "false"), e(h)
                            }) : t.noop
                        }

                        function h() {
                            p = s.prop("offsetHeight");
                            var e = -p * v + "px";
                            f.css({"margin-top": e, "margin-bottom": e}), m()
                        }

                        var p, f, g = t.noop, b = 0, E = 0, v = c.mdShrinkSpeedFactor || .5, $ = e.throttle(m),
                            M = o.debounce(h, 5e3);
                        d.$on("$mdContentLoaded", l), c.$observe("mdScrollShrink", i), c.ngShow && d.$watch(c.ngShow, h), c.ngHide && d.$watch(c.ngHide, h), d.$on("$destroy", g)
                    }

                    i(s), t.isDefined(c.mdScrollShrink) && l()
                }
            }
        }
        ...
        function e(e, n, o, i, r, a, d, s, c) {
            function l(d, l, h) {
                function p() {
                    t.isDefined(h.mdDelay) || (d.delay = m)
                }
                ...
                function v() {
                    ...
                    var o = !1, r = t.element(n);
                    if (T[0] && "MutationObserver" in n) {
                        var a = new MutationObserver(function (e) {
                            e.forEach(function (e) {
                                "disabled" === e.attributeName && T[0].disabled && ($(!1), d.$digest())
                            })
                        });
                        a.observe(T[0], {attributes: !0})
                    }
                    var s = function () {
                        c = document.activeElement === T[0]
                    }, c = !1;
                    r.on("blur", s), r.on("resize", _), document.addEventListener("scroll", e, !0), d.$on("$destroy", function () {
                        r.off("blur", s), r.off("resize", _), document.removeEventListener("scroll", e, !0), a && a.disconnect()
                    });
                    var l = function (e) {
                        return "focus" === e.type && c ? void (c = !1) : (T.on("blur mouseleave touchend touchcancel", m), void $(!0))
                    }, m = function () {
                        var e = d.hasOwnProperty("autohide") ? d.autohide : h.hasOwnProperty("mdAutohide");
                        (e || o || i[0].activeElement !== T[0]) && (T.off("blur mouseleave touchend touchcancel", m), T.triggerHandler("blur"), $(!1)), o = !1
                    };
                ...
                function M() {
                    return k.append(l), r.hasComputedStyle(l, "display", "none") ? (d.visible = !1, void l.detach()) : (C(), void t.forEach([l, w], function (e) {
                        s.addClass(e, "md-show")
                    }))
                }
                ...
                function y() {
                    ...
                    t.forEach([l, w], function (t) {
                        t.parent() && t.hasClass("md-show") && e.push(s.removeClass(t, "md-show"))
                    }), c.all(e).then(function () {
                        d.visible || l.detach()
                    })
                }
                ...
                function A() {
                    ...
                    var n = r.offsetRect(l, k), o = r.offsetRect(T, k), i = t(d.direction), a = l.prop("offsetParent");
                    d.direction ? i = e(i) : a && i.top > a.scrollHeight - n.height - u && (i = e(t("top"))), l.css({
                        left: i.left + "px",
                        top: i.top + "px"
                    })
                }
                ...
                a(l);
                var T = r.getParentWithPointerEvents(l), w = t.element(l[0].getElementsByClassName("md-content")[0]),
                    k = t.element(document.body), _ = o.throttle(function () {
                        C()
                    });
                s.pin && s.pin(l, T), p(), E(), v(), f(), g(), b()
            }
        ...
        function i(e) {
            return {
                ...
                compile: function (t, n) {
                    var o = n.mdVirtualRepeat, i = o.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)\s*$/), r = i[1],
                        a = e(i[2]), d = n.mdExtraName && e(n.mdExtraName);
        ...
        function r(e, n, o, i, r, a, d) {
            this.$scope = e, this.$element = n, this.$attrs = o, this.$browser = i, this.$document = r, this.$rootScope = a, this.$$rAF = d, this.onDemand = o.hasOwnProperty("mdOnDemand"), this.browserCheckUrlChange = i.$$checkUrlChange, this.newStartIndex = 0, this.newEndIndex = 0, this.newVisibleEnd = 0, this.startIndex = 0, this.endIndex = 0, this.itemSize = e.$eval(o.mdItemSize) || null, this.isFirstRender = !0, this.isVirtualRepeatUpdating_ = !1, this.itemsLength = 0, this.unwatchItemSize_ = t.noop, this.blocks = {}, this.pooledBlocks = [], e.$on("$destroy", t.bind(this, this.cleanupBlocks_))
        }
        ...
        o.$inject = ["$$rAF", "$mdUtil", "$parse", "$rootScope", "$window", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
            ...
            if (this.sizer.innerHTML = "", d > e) this.sizer.style[t] = e + "px"; else {
                ...
                for (var r = 0; o > r; r++) this.sizer.appendChild(i.cloneNode(!1));
            ...
            if (!(e === this.scrollOffset || e > this.scrollSize - this.size)) {
                ...
                if (t) {
                    var n = Math.max(0, Math.floor(e / t) - s),
        ...
        }, i.$inject = ["$parse"], r.$inject = ["$scope", "$element", "$attrs", "$browser", "$document", "$rootScope", "$$rAF"], r.Block, r.prototype.link_ = function (e, n, o, i, r) {
            ...
            s.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(s), this.$element[0].nextSibling), c.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(c), this.blocks[l] && this.blocks[l].element[0].nextSibling), this.$browser.$$checkUrlChange = this.browserCheckUrlChange, this.startIndex = this.newStartIndex, this.endIndex = this.newEndIndex, this.isVirtualRepeatUpdating_ = !1
        ...
        function e(e) {
            function t(t, r, a) {
                var d = parseInt(a.mdWhiteframe, 10) || i;
                (d > o || n > d) && (e.warn("md-whiteframe attribute value is invalid. It should be a number between " + n + " and " + o, r[0]), d = i), r.addClass("md-whiteframe-" + d + "dp")
            }
        ...
        function e(e, o, d, s, c, l, m, u, h, p) {
            function f() {
                d.initOptionalProperties(e, h, {
                    searchText: null,
                    selectedItem: null
                }), c(o), v(), d.nextTick(function () {
                    M(), b(), E(), o.on("focus", E)
                })
            }
            ...
            function g() {
                ...
                function n() {
                    ...
                    e.right > m.right - r && (t.left = c.right - e.width + "px"), ue.$.scrollContainer.css(t)
                }

                if (!ue) return d.nextTick(g, !1, e);
                var s, c = ue.wrap.getBoundingClientRect(), l = ue.snap.getBoundingClientRect(),
                    m = ue.root.getBoundingClientRect(), u = l.bottom - m.top, p = m.bottom - l.top,
                    f = c.left - m.left, b = c.width, E = t();
                h.mdFloatingLabel && (f += a, b -= 2 * a), s = {
                    left: f + "px",
                    minWidth: b + "px",
                    maxWidth: Math.max(c.right - m.left, m.right - c.left) - r + "px"
                }, u > p && m.height - c.bottom - r < i ? (s.top = "auto", s.bottom = p + "px", s.maxHeight = Math.min(i, c.top - m.top - r) + "px") : (s.top = u - E + "px", s.bottom = "auto", s.maxHeight = Math.min(i, m.bottom + d.scrollTop() - c.bottom - r) + "px"), ue.$.scrollContainer.css(s), d.nextTick(n, !1)
            }

            function b() {
                ue.$.root.length && (c(ue.$.scrollContainer), ue.$.scrollContainer.detach(), ue.$.root.append(ue.$.scrollContainer), m.pin && m.pin(ue.$.scrollContainer, u))
            }
            ...
            function v() {
                ...
                h.$observe("disabled", function (e) {
                    ce.isDisabled = d.parseAttributeBoolean(e, !1)
                }), h.$observe("required", function (e) {
                    ce.isRequired = d.parseAttributeBoolean(e, !1)
                }), h.$observe("readonly", function (e) {
                    ce.isReadonly = d.parseAttributeBoolean(e, !1)
                }), e.$watch("searchText", n ? d.debounce(O, n) : O), e.$watch("selectedItem", _), t.element(l).on("resize", g), e.$on("$destroy", $)
            }

            function $() {
                if (ce.hidden || d.enableScrolling(), t.element(l).off("resize", g), ue) {
            ...
            function w() {
                ge || ue.input.focus(), pe = !1, ce.hidden = j()
            }
            ...
            function O(t, n) {
                ce.index = q(), t !== n && B(e.selectedItem).then(function (o) {
                    t !== o && (e.selectedItem = null, t !== n && N(), X() ? de() : (ce.matches = [], z(!1), te()))
                })
            }
            ...
            function R(e) {
                e && (pe = !1, ge = !1), ue.input.blur()
            }

            function L() {
                ge = !0, t.isString(e.searchText) || (e.searchText = ""), ce.hidden = j(), ce.hidden || de()
            }
            ...
            function j() {
                return ce.loading && !W() ? !0 : Y() ? !0 : ge ? !V() : !0
            }
            ...
            function Z(t) {
                d.nextTick(function () {
                    B(ce.matches[t]).then(function (e) {
                        ...
                        e.selectedItem = ce.matches[t], z(!1)
                    })
                }, !1)
            }

            function J() {
                z(!0), ce.index = 0, ce.matches = [], e.searchText = "";
            ...
            function ee(n) {
                function o(t) {
                    t && (t = p.when(t), Ee++, z(!0), d.nextTick(function () {
                ...
                function i(t) {
                    he[a] = t, (n || "") === (e.searchText || "") && (ce.matches = t, ce.hidden = j(), ce.loading && z(!1), e.selectOnMatch && se(), te(), g())
                }

                var r = e.$parent.$eval(me), a = n.toLowerCase(), s = t.isArray(r), c = !!r.then;
                s ? i(r) : c && o(r)
            }
            ...
            function ne() {
                if (be === ce.matches.length) return "";
                switch (be = ce.matches.length, ce.matches.length) {
                    case 0:
            ...
            function oe() {
                if (ue.li[0]) {
                    var e = ue.li[0].offsetHeight, t = e * ce.index, n = t + e, o = ue.scroller.clientHeight,
                        i = ue.scroller.scrollTop;
                    i > t ? re(t) : n > i + o && re(n - o)
                }
            }
            ...
            function ae() {
                ...
                return ce.hasNotFound && !W() && (!ce.loading || ie()) && e >= F() && (ge || pe) && !Y()
            }

            function de() {
                var t = e.searchText || "", n = t.toLowerCase();
                !e.noCache && he[n] ? (ce.matches = he[n], te()) : ee(t), ce.hidden = j()
            }
        ...
        function e(e, n, o) {
            ...
            function a(e, t) {
                var n = "";
                return t.indexOf("^") >= 1 && (n += "^"), n += e, t.indexOf("$") >= 1 && (n += "$"), new RegExp(r(n), t.replace(/[\$\^]/g, ""))
            }
        ...
        function e(e, o) {
            function i(n, i) {
                return n.append(o.processTemplate(r)), function (n, o, i, r) {
                    o.addClass("md-chip"), e(o), r && t.element(o[0].querySelector(".md-chip-content")).on("blur", function () {
        ...
        function e(e, t, a, d, s) {
            function c(n, o) {
                ...
                var c = i("md-chips>*[md-chip-remove]") || m.remove, l = i("md-chips>md-chip-template") || m["default"],
                    u = i("md-chips>md-autocomplete") || i("md-chips>input") || m.input, h = r.find("md-chip");
                return r[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."), function (n, i, r, d) {
                    ...
                    var p = d[0];
                    if (p.chipContentsTemplate = l, p.chipRemoveTemplate = c, p.chipInputTemplate = u, i.attr({
                        "aria-hidden": !0,
                        tabindex: -1
                    }).on("focus", function () {
                        p.onFocus()
                    }), o.ngModel && (p.configureNgModel(i.controller("ngModel")), r.mdTransformChip && p.useTransformChipExpression(), r.mdOnAppend && p.useOnAppendExpression(), r.mdOnAdd && p.useOnAddExpression(), r.mdOnRemove && p.useOnRemoveExpression(), r.mdOnSelect && p.useOnSelectExpression(), u != m.input && n.$watch("$mdChipsCtrl.readonly", function (e) {
                        e || t.nextTick(function () {
                            0 === u.indexOf("<md-autocomplete") && p.configureAutocomplete(i.find("md-autocomplete").controller("mdAutocomplete")), p.configureUserInput(i.find("input"))
                        })
                    }), t.nextTick(function () {
                        var e = i.find("input");
                        ...
                        s(function () {
                            i.find("md-chips-wrap").prepend(f)
                        })
                    }
                }
            }
        ...
        var n = '      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus(), \'md-readonly\': !$mdChipsCtrl.ngModelCtrl }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index, \'md-readonly\': $mdChipsCtrl.readonly}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-click="!$mdChipsCtrl.readonly && $mdChipsCtrl.focusChip($index)"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div ng-if="!$mdChipsCtrl.readonly"               class="md-chip-remove-container"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
            ...
            i = "      <span>{{$chip}}</span>",
            r = '      <button          class="md-chip-remove"          ng-if="!$mdChipsCtrl.readonly"          ng-click="$mdChipsCtrl.removeChipAndFocusInput($$replacedScope.$index)"          type="button"          aria-hidden="true"          tabindex="-1">        <md-icon md-svg-icon="md-close"></md-icon>        <span class="md-visually-hidden">          {{$mdChipsCtrl.deleteButtonLabel}}        </span>      </button>';
        ...
        function e(e, t, n) {
            function o(o, i, r) {
                ...
                function d() {
                    r.mdSvgIcon || r.mdSvgSrc || (r.mdFontIcon && i.addClass("md-font " + r.mdFontIcon), i.addClass(e.fontSet(r.mdFontSet)))
                }

                t(i), d();
                var s = r.alt || r.mdFontIcon || r.mdSvgIcon || i.text(),
                    c = r.$normalize(r.$attr.mdSvgIcon || r.$attr.mdSvgSrc || "");
                r["aria-label"] || ("" === s || a() ? i.text() || n.expect(i, "aria-hidden", "true") : (n.expect(i, "aria-label", s), n.expect(i, "role", "img"))), c && r.$observe(c, function (t) {
        ...
        function i(n, o, i, r, a, d) {
            function s(e) {
                if (e = e || "", $[e]) return i.when(l($[e]));
                if (M.test(e) || y.test(e)) return p(e).then(m(e));
            ...
            var $ = {}, M = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i,
                y = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
            return b.prototype = {clone: v, prepare: E}, s.fontSet = c, s
        }
        ...
        n.prototype = {
            icon: function (e, t, n) {
                ...
                return this.preloadIcons(o), i(r, e, t, n, o, a)
            }]
        }, i.$inject = ["config", "$http", "$q", "$log", "$templateCache", "$mdUtil"]
    }(), function () {
        function e(e, o, i, r, a, d, s, c) {
            var l, m, u = this;
            this.nestLevel = parseInt(o.mdNestLevel, 10) || 0, this.init = function (n, o) {
                o = o || {}, l = n, m = i[0].querySelector("[ng-click],[ng-mouseenter]"), m.setAttribute("aria-expanded", "false"), this.isInMenuBar = o.isInMenuBar, this.nestedMenus = a.nodesToArray(l[0].querySelectorAll(".md-nested-menu")), l.on("$mdInterimElementRemove", function () {
                    u.isOpen = !1
                });
                ...
                l.attr("id", d), t.element(m).attr({
                    "aria-owns": d,
                    "aria-haspopup": "true"
                }), r.$on("$destroy", this.disableHoverListener), l.on("$destroy", function () {
                    e.destroy()
                })
            };
            var h, p, f = [];
            this.enableHoverListener = function () {
                f.push(s.$on("$mdMenuOpen", function (e, t) {
                ...
                })), f.push(s.$on("$mdMenuClose", function (e, t) {
                    l[0].contains(t[0]) && (u.currentlyOpenMenu = n)
                })), p = t.element(a.nodesToArray(l[0].children[0].children)), p.on("mouseenter", u.handleMenuItemHover), p.on("mouseleave", u.handleMenuItemMouseLeave)
            }, this.disableHoverListener = function () {
                for (; f.length;) f.shift()();
                p && p.off("mouseenter", u.handleMenuItemHover), p && p.off("mouseleave", u.handleMenuMouseLeave)
                ...
                t && t.stopPropagation(), t && t.preventDefault(), u.isOpen || (u.enableHoverListener(), u.isOpen = !0, m = m || (t ? t.target : i[0]), m.setAttribute("aria-expanded", "true"), r.$emit("$mdMenuOpen", i), e.show({
                    scope: r,
                    mdMenuCtrl: u,
                ...
                e ? (l.attr("aria-hidden", "false"), i[0].classList.add("md-open"), t.forEach(u.nestedMenus, function (e) {
                    e.classList.remove("md-open")
                })) : (l.attr("aria-hidden", "true"), i[0].classList.remove("md-open")), r.$mdMenuIsOpen = u.isOpen
                ...
                return u.isOpen ? e.destroy() : c.when(!1)
            }, this.close = function (n, o) {
                if (u.isOpen) {
                    u.isOpen = !1;
                    var a = t.extend({}, o, {skipFocus: n});
                    if (r.$emit("$mdMenuClose", i, a), e.hide(null, o), !n) {
                        var d = u.restoreFocusTo || i.find("button")[0];
        ...
        function e(e) {
            function o(n) {
                n.addClass("md-menu");
                var o = n.children()[0];
                if (o.hasAttribute("ng-click") || (o = o.querySelector("[ng-click],[ng-mouseenter]") || o), !o || "MD-BUTTON" != o.nodeName && "BUTTON" != o.nodeName || o.hasAttribute("type") || o.setAttribute("type", "button"), 2 != n.children().length) throw Error(r + "Expected two children elements.");
            ...
            function i(e, o, i, r) {
                var a = r[0], d = r[1] != n,
                    s = t.element('<div class="md-open-menu-container md-whiteframe-z2"></div>'), c = o.children()[1];
                c.hasAttribute("role") || c.setAttribute("role", "menu"), s.append(c), o.on("$destroy", function () {
                    s.remove()
        ...
        function e(e) {
            function o(e, o, a, d, s, c, l, m, u) {
                ...
                function p(e, t, n) {
                    ...
                    return n.cleanupInteraction(), n.cleanupResizing(), n.hideBackdrop(), n.$destroy === !0 ? i() : o().then(i)
                }
                ...
                function f(n, i, r) {
                    ...
                    function f() {
                        ...
                        function d(t) {
                            ...
                            function i(e, t) {
                                if (!e) return !1;
                                for (var n, o = 0; n = t[o]; ++o) for (var i, r = [n, "data-" + n, "x-" + n], a = 0; i = r[a]; ++a) if (e.hasAttribute(i)) return !0;
                                return !1
                            }
                        ...
                        var s = r.menuContentEl[0].querySelector("[md-menu-focus-target]");
                        if (!s) {
                    ...
                    return u(r), o.inherit(r.menuContentEl, r.target), r.cleanupResizing = p(), r.hideBackdrop = h(n, i, r), d().then(function (e) {
                ...
                function v(t, o) {
                    ...
                    var c, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), h = d[0].body,
                        p = h.getBoundingClientRect(), f = s.getComputedStyle(m),
                        ...
                        E = {
                            ...
                            right: p.right - r
                        }, v = {top: 0, left: 0, right: 0, bottom: 0}, $ = {top: 0, left: 0, right: 0, bottom: 0},
                        M = o.mdMenuCtrl.positionMode();
                    "target" != M.top && "target" != M.left && "target-right" != M.left || (c = a(), c && (c = c.firstElementChild || c, c = c.querySelector("[md-menu-align-target]") || c, v = c.getBoundingClientRect(), $ = {
                    ...
                    switch (M.left) {
                        case"target":
                            y.left = $.left + b.left - v.left, C += "left";
                            break;
                        case"target-right":
        ...
        e.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function () {
            ...
            e.on("keydown", this.handleKeyDown), this.parentToolbar = t.getClosest(e, "MD-TOOLBAR"), r.push(this.$rootScope.$on("$mdMenuOpen", function (t, n) {
                ...
                var d = i.getMenus();
                if (-1 != d.indexOf(r[0]) && (e[0].classList.remove("md-open"), r[0].classList.remove("md-open")), e[0].contains(r[0])) {
                    for (var s = r[0]; s && -1 == d.indexOf(s);) s = t.getClosest(s, "MD-MENU", !0);
        ...
        function e() {
            return {
                require: ["mdMenuItem", "?ngModel"], priority: 210, compile: function (e, n) {
                    function o(n, o, i) {
                        i = i || e, i instanceof t.element && (i = i[0]), i.hasAttribute(n) || i.setAttribute(n, o)
                    }
                    ...
                    if ("checkbox" == n.type || "radio" == n.type) {
                        var r = e[0].textContent, a = t.element('<md-button type="button"></md-button>');
                        a.html(r), a.attr("tabindex", "0"), e.html(""), e.append(t.element('<md-icon md-svg-icon="check"></md-icon>')), e.append(a), e[0].classList.add("md-indent"), o("role", "checkbox" == n.type ? "menuitemcheckbox" : "menuitemradio", a), t.forEach(["ng-disabled"], i)
        ...
        function e() {
            function e(e, o, i, r) {
                if (r) {
                    var a = r.getTabElementIndex(o), d = n(o, "md-tab-body").remove(),
                        s = n(o, "md-tab-label").remove(), c = r.insertTab({
                            scope: e,
                            parent: e.$parent,
                            index: a,
                            element: o,
            ...
            function n(e, n) {
                for (var o = e[0].children, i = 0, r = o.length; r > i; i++) {
                    var a = o[i];
        ...
        function e(e, o, i, r, a, d, s, c, l, m) {
            function u() {
                se.selectedIndex = se.selectedIndex || 0, h(), f(), p(), m(o), d.nextTick(function () {
                    oe(), J(), ie(), se.tabs[se.selectedIndex] && se.tabs[se.selectedIndex].scope.select(), he = !0, Y()
                })
            }

            function h() {
                var e = c.$mdTabsTemplate, n = t.element(le.data);
                n.html(e), l(n.contents())(se.parent), delete c.$mdTabsTemplate
            }

            function p() {
                t.element(i).on("resize", O), e.$on("$destroy", E)
            }
            ...
            function g(e, t) {
                ...
                t && W(e, t), c.$observe(n, function (t) {
                    se[e] = t
                })
            }
            ...
            function b(e, t) {
                ...
                t && W(e, t), c.hasOwnProperty(o) && n(c[o]), c.$observe(o, n)
            }

            function E() {
                ue = !0, t.element(i).off("resize", O)
            }

            function v(e) {
                t.element(le.wrapper).toggleClass("md-stretch-tabs", q()), ie()
            }

            function $(e) {
                se.shouldCenterTabs = z()
            }
            ...
            function y(e, t) {
                e !== t && (se.maxTabWidth = G(), se.shouldCenterTabs = z(), d.nextTick(function () {
                    se.maxTabWidth = G(), J(se.selectedIndex)
                }))
            }
            ...
            function A(n) {
                ...
                t.element(le.paging).css(r.CSS.TRANSFORM, "translate3d(" + o + ", 0, 0)"), e.$broadcast("$mdTabsPaginationChanged")
            }
            ...
            function w(t, n) {
                t !== n && (se.selectedIndex = V(t), se.lastSelectedIndex = n, se.updateInkBarStyles(), oe(), J(t), e.$broadcast("$mdTabsChanged"), se.tabs[n] && se.tabs[n].scope.deselect(), se.tabs[t] && se.tabs[t].scope.select())
            }
            ...
            function _() {
                _.watcher || (_.watcher = e.$watch(function () {
                    d.nextTick(function () {
                        _.watcher && o.prop("offsetParent") && (_.watcher(), _.watcher = null, O())
                    }, !1)
                }))
            }
            ...
            function x(e) {
                switch (e.keyCode) {
                    ...
                    case r.KEY_CODE.ENTER:
                        e.preventDefault(), ce || (se.selectedIndex = se.focusIndex)
                }
                se.lastClick = !1
            }

            function N(e, t) {
                ce || (se.focusIndex = se.selectedIndex = e), se.lastClick = !0, t && se.noSelectClick || d.nextTick(function () {
                    se.tabs[e].element.triggerHandler("click")
                }, !1)
            }

            function H(e) {
                se.shouldPaginate && (e.preventDefault(), se.offsetLeft = ae(se.offsetLeft - e.wheelDelta))
            }

            function S() {
                var e, t, n = le.canvas.clientWidth, o = n + se.offsetLeft;
                for (e = 0; e < le.tabs.length && (t = le.tabs[e], !(t.offsetLeft + t.offsetWidth > o)); e++) ;
                se.offsetLeft = ae(t.offsetLeft)
            }

            function D() {
                var e, t;
                for (e = 0; e < le.tabs.length && (t = le.tabs[e], !(t.offsetLeft + t.offsetWidth >= se.offsetLeft)); e++) ;
                se.offsetLeft = ae(t.offsetLeft + t.offsetWidth - le.canvas.clientWidth)
            }

            function O() {
                se.lastSelectedIndex = se.selectedIndex, se.offsetLeft = ae(se.offsetLeft), d.nextTick(function () {
            ...
            function L(e) {
                if (!ue) {
                    ...
                    ne(), se.selectedIndex === t && (n.scope.deselect(), se.tabs[se.selectedIndex] && se.tabs[se.selectedIndex].scope.select()), d.nextTick(function () {
                        Y(), se.offsetLeft = ae(se.offsetLeft)
                    })
                }
            }
            ...
            function P(e, n) {
                ...
                return t.isDefined(n) ? se.tabs.splice(n, 0, r) : se.tabs.push(r), ee(), te(), d.nextTick(function () {
            ...
            function U() {
                ...
                return e && e.offsetLeft + e.offsetWidth > le.canvas.clientWidth + se.offsetLeft
            }
            ...
            function q() {
                switch (se.stretchTabs) {
                    ...
                    case"never":
                        return !1;
                    default:
                        return !se.shouldPaginate && i.matchMedia("(max-width: 600px)").matches
                }
            }
            ...
            function Y() {
                q() || K(), se.maxTabWidth = G(), se.shouldPaginate = j()
            }
            ...
            function Q(e, t) {
                var n, o = t ? "focusIndex" : "selectedIndex", i = se[o];
                for (n = i + e; se.tabs[n] && se.tabs[n].scope.disabled; n += e) ;
                se.tabs[n] && (se[o] = n)
            }
            ...
            function J(e) {
                if (null == e && (e = se.focusIndex), le.tabs[e] && !se.shouldCenterTabs) {
                    var t = le.tabs[e], n = t.offsetLeft, o = t.offsetWidth + n;
                    se.offsetLeft = Math.max(se.offsetLeft, ae(o - le.canvas.clientWidth + 64)), se.offsetLeft = Math.min(se.offsetLeft, ae(n))
                }
            }
            ...
            function oe() {
                ...
                if (!se.tabs.length) return me.push(oe);
                var e = le.contents[se.selectedIndex], t = e ? e.offsetHeight : 0, i = le.wrapper.offsetHeight,
                    r = t + i, a = o.prop("clientHeight");
                if (a !== r) {
                    "bottom" === o.attr("md-align-tabs") && (a -= i, r -= i, o.attr("md-border-bottom") !== n && ++a), ce = !0;
                    var c = {height: a + "px"}, l = {height: r + "px"};
                    o.css(c), s(o, {
                        from: c,
                        to: l,
            ...
            function ie() {
                if (!le.tabs[se.selectedIndex]) return void t.element(le.inkBar).css({left: "auto", right: "auto"});
                if (!se.tabs.length) return me.push(se.updateInkBarStyles);
                if (!o.prop("offsetParent")) return _();
                var e, n = se.selectedIndex, i = le.paging.offsetWidth, r = le.tabs[n], a = r.offsetLeft,
                    s = i - a - r.offsetWidth;
                se.shouldCenterTabs && (e = Array.prototype.slice.call(le.tabs).reduce(function (e, t) {
                    return e + t.offsetWidth
                }, 0), i > e && d.nextTick(ie, !1)), re(), t.element(le.inkBar).css({left: a + "px", right: s + "px"})
            }

            function re() {
                var e = se.selectedIndex, n = se.lastSelectedIndex, o = t.element(le.inkBar);
                t.isNumber(n) && o.toggleClass("md-left", n > e).toggleClass("md-right", e > n)
            }

            function ae(e) {
                if (!le.tabs.length || !se.shouldPaginate) return 0;
        ...
        function e(e, t) {
            function n(n, o, i, r) {
                ...
                if (r) {
                    ...
                    return o.html(n.template), e(o.contents())(c), o.on("DOMSubtreeModified", function () {
