    ...
    return{
        ...
        controller : ['$scope','$http','$timeout','$mdDialog','$compile',function($scope,$http,$timeout,$mdDialog,$compile){
            ...
            $scope.addEnvironmentPcOne=function(){
                ...
                var sub_cat_tab;
                    ...
                    '<tr><td>Enter Cost:</td><td><input type="number" name="cost" placeholder="enter cost"  id="cost"></td>' +
                        '</tr>' +
                        '<tr><td>' +
                        '<input type="radio" name="pop" id="pop" value="Positively Influenced">Population influence +ve</td>' +
                        '<td><input type="radio" name="pop" id="pop" value="Negatively Influenced">Population influence -ve</td>'+
                        '</tr>' +
            ...
            function connectivityDialogsController($scope, $mdDialog){
                ...
                //         var y = "environment.schedule1";
                //         console.log(y)
                // $.post( "services/environment/scheme_category.php",'', function(response1) {
                //     console.log(response1);
                //
                //     for (var i = 0; i < response1.length; i++) {
                //         str_type = str_type + '<option value="' + response1[i].category_type + '">' + response1[i].category + '</option>';
