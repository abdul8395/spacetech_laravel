                ...
                $scope.pssEnvironmentStory=function(data,lon,lat,sc_name,cost,category_text,scheme_sub_cat_text,popu,radio_chk,scheme_schedule){
                    ...
                    $mdDialog.show({
                        ...
                        '<div class="row">' +
                            '<div class="col-md-10" style="padding-left: 45px;padding-right: 0;margin-top: 10px;">' +
                                '<h4 style="text-align: center;padding: 10px; font-size:16px; color: #fff; background-color:#48A947; margin-bottom: 0;text-transform: uppercase;">Assessment Report of Environment Scheme</h4>' +
                        ...
                        '<div class="row" style="padding-left: 15px;padding-right: 15px;">'+
                            ...
                            '</div>'+
                            '<div class="col-md-6">' +
                                '<div style=" width90%; height: 422px" id="map4"></div>'+
                            '</div>' +
                        '</div>'+

                        //guages
                        '<div class="row" style="margin-left: 0;padding-left: 15px;padding-right: 15px;">'+
                        ...
                        '<div class="row" style="margin-left: 0px;padding-left: 15px;padding-right: 15px;">'+
                            '<div class="col-md-12" id="total_score" style="text-align:center; margin: auto;height:275px;">' +
                                ...
                                '<p></p>'+
                            '</div>'+
                            '<div class="col-md-3" id="aqi" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="wqi" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="water_bodies" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="heritage" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="protected" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="hazard" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                            ...
                            '</div>'+
                            '<div class="col-md-3" id="landuse" style="text-align:center; margin: auto;height:350px;">' +
                                '<canvas  width="200" height="100"></canvas>'+
                                '<h4></h4>'+
                                '<h6></h6>'+
                        ...
                        '</div>' +
                        '</div>'+
                        '<div class="row" style="margin-left: 0;padding-left: 15px;padding-right: 15px;padding-top: 20px;">'+
                            '<div class="col-md-12">'+
                                '<div id="env_logistics"></div>'+
                            '</div>'+
                        '</div>'+
                        //table env_logistics end
                        '<div class="row" style="margin-left: 0;padding-left: 0;padding-right: 0;padding-top: 20px;">'+
                            '<div class="col-md-12">' +
                    ...
                    setTimeout(function(){
                        ...
                        var env_logistics='<table class="table table-bordered table-striped">' +
                            '<tr>' +
                            '<td width="80%">Air Quality Index(no2)</td>'+
                            '<td width="20%">'+Number(data.dimensions[0].value_no2).toFixed(1)+'</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Air Quality Index(pm2.5)</td>'+
                            '<td>'+Number(data.dimensions[0].value_pm2).toFixed(1)+'</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Water Quality Index</td>'+
                            '<td>'+Number(data.dimensions[0].value_gwq).toFixed(1)+' </td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Water Bodies</td>'+
                            '<td>'+Number(data.dimensions[0].distance_waterbodies).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of canal/Distributries</td>'+
                            '<td>'+Number(data.dimensions[0].distance_canal).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Cultural/Heritage Sites</td>'+
                            '<td>'+Number(data.dimensions[0].distance_heritage).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Conservation Area</td>'+
                            '<td>'+Number(data.dimensions[0].distance_conservation_area).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Protected Area</td>'+
                            '<td>'+Number(data.dimensions[0].distance_protected_area).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Natural Hazards (floods)</td>'+
                            '<td>'+Number(data.dimensions[0].distance_flood).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '<tr>' +
                            '<td>Distance of Natural Hazards (Earthquackes)</td>'+
                            '<td>'+Number(data.dimensions[0].distance_earthquake_epicenter).toFixed(1)+' KM</td>'+
                            '</tr>'+
                            '</table>';
...
function addEnvironmentguage(Names,container,val){
    ...
    if(val_new>=0 && val_new<=20)
    {
        ...
        document.getElementById(container).querySelector('h6').innerHTML='<span style="color: #ea1010;font-size:16px;">'+val+'</span>';
    }
    else if(val_new>20 && val_new <=40)
    {
        color='#c4741b';
        document.getElementById(container).querySelector('h4').innerHTML='<span style="color: #98999F">'+Names+'</span>';
        document.getElementById(container).querySelector('h6').innerHTML='<span style="color: #c4741b;font-size:16px;">'+val+'</span>';
    }
    else if(val_new>40 && val_new <=60)
    {
        color='#d2d100';
        document.getElementById(container).querySelector('h4').innerHTML='<span style="color: #98999F">'+Names+'</span>';
        document.getElementById(container).querySelector('h6').innerHTML='<span style="color: #d2d100;font-size:16px;">'+val+'</span>' ;
    }
    else if(val_new>60 && val_new <=80)
    {
        color='#22994a';
        document.getElementById(container).querySelector('h4').innerHTML='<span style="color: #98999F">'+Names+'</span>';
        document.getElementById(container).querySelector('h6').innerHTML='<span style="color: #22994a ;font-size:16px;">'+val+'</span>';
    }
