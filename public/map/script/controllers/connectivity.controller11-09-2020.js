        ...
        controller : ['$scope','$http','$timeout','$mdDialog','$compile',function($scope,$http,$timeout,$mdDialog,$compile){
            ...
            $scope.addConnectivityPcOne=function(){
                ...
                $.post( "services/connectivity/connectivity_scheme_types.php",'', function(response1) {
                    ...
                    '</tr>' +
                    '<tr><td>' +
                    '<input type="radio" id="shp_up"  name="geom" value="point">upload shp</td>' +
                    '<td><input type="radio" id="kml_up" name="geom"  value="polygon">upload kml</td>'+
                    '</tr>' +

                    '<tr id="shp_display" style="display:none;">'+
                     '<td>Upload SHP</td>'+
                    '<td><input type="file" id="shp_con" class="fileclass" class="ng-hide"  accept=".zip"/></td>' +
                    ...
                    '<td>Upload KML</td>'+
                    '<td><input type="file" id="kml_con" class="fileclass" class="ng-hide"  accept=".kml"/></td>' +
                    // '<button  type="button" ng-click="uploadFile('+"'shp_con'"+')" class="btn-subnav dropdown-toggle bg_style" data-toggle="dropdown">' +
                    // '<span class="glyphicon glyphicon-file"></span>' +
                    // 'SHP' +
                    // '</button></td>'+
                    '</tr>'+
                    '<tr><td>Scheme Type:</td><td><select onchange="" id="pss_con_scheme">' +
            ...
            function connectivityDialogsController($scope, $mdDialog){
                ...
                $scope.getCategory=function(lineGeom,sc){
                    ...
                    if(sc=='new') {
                        $("#rightnav").append('<div class="row" style="padding-left:20px;padding-top:20px;"><div class="col-md-12"><button onclick=getCategory1(' +"'"+JSON.stringify(lineGeom)+"'"+ ')>click me to view report</button></div>');
               ...
               //     angular.element(document.querySelector('#rightpanel')).append($compile('<div class="row" style="padding-left:20px;"><div class="col-md-12"><button ng-click="getCategory()">click me to view report</button></div>')($scope))
                   ...
                   // console.log(data.ptiai[0].tehsil_name)
                    $mdDialog.show({
                      ...
                      //  '<div>'+
                        ...
                        '<a href="createConnectivityPdf1.php?len='+con_line_lengths+'&scheme_val='+scheme_val+'&scheme_name='+scheme_name+'&scheme_type='+scheme_type+'&cost='+cost+
                ...
                $scope.addconnectivityguage= function(Names,container,val){
                    ...
                    //             {strokeStyle: "#FFDD00", min: 5, max: 7}, // Yellow
                    //             {strokeStyle: "#30B32D", min: 7, max: 12}, // Green
                    //         ],//
                ...
                $scope.tableThreeCreation=function(data){
                    ...
                    // if(data.categoery[0].category=='Category A'){
                    //     str='<div class="row" style="margin-left: 0px;padding-left: 30px;padding-right: 30px;padding-top: 20px;">' +
                    //     '<div class="col-md-12"  style="background-color:green;font-size: 20px;text-align: center;">' +
                    //     '<h5>The scheme is important as per PSS Connectivity Component : Yes</h5>' +
                    //     '</div>' +
                    //     '</div>' ;
                    // }
                    // else if (data.categoery[0].category=='Category B'){
                    ...
                    //         str='<div class="row" style="margin-left: 0px;padding-left: 30px;padding-right: 30px;padding-top: 20px;">' +
                    //             '<div class="col-md-12"  style="background-color:green;font-size: 20px;text-align: center;">' +
                    //             '<h5>The scheme is important as per PSS Connectivity Component : NO</h5>' +
                    //             '</div>' +
                    //             '</div>' ;
                    //     }
                    // }
                    ...
                    if(data.categoery[0]) {
                       str = str+ '<div class="col-md-12"  style="font-size: 20px;text-align: center;padding-left: 30px;padding-right: 30px;padding-bottom:30px;">' +
                           ...
                           '<td>' + parseInt(data.health_details5[0].RHU)*2 +'</td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;align:center;">' +
                            '<td>8</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'industry1'"+')">Industry</td></td>' +
                           ...
                           '<td>' + data.industries_detail5[0].Small_Industries + '</td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;align:center;">' +
                            '<td>9</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'education1'"+')">Education</a></td>' +
                          ...
                          //  '<td rowspan="4"> Education Details</td>' +
                           ...
                           '<tr style="background-color: #F9F9F9;align:center;">' +
                            '<td>10</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'road1'"+')">Roads</a></td>' +
                        ...
                        var str =
                         //   '<div class="row" style="margin-left: 0px;padding-left: 30px;padding-right: 30px;padding-top: 20px;">' +
                          ...
                          //  '<div class="row" style="margin-left: 0px;padding-left: 15px;padding-right: 15px;padding-top: 20px;">' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>8</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'industry2'"+')">Industry</a></td></td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>9</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'education2'"+')">Education</a></td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>10</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'road2'"+')">Roads</a></td>' +
                    ...
                    if(data.categoery[0]) {
                        var str =
                          ...
                          //  '<td rowspan="4"> Health Details</td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>8</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'industry3'"+')">Industry</a></td>' +
                           ...
                           // '<td rowspan="3">Industry Details</td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>9</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'education3'"+')">Education</a></td>' +
                          ...
                          //  '<td rowspan="4"> Education Details</td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>10</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'road3'"+')">Roads</a></td>' +
                    ...
                    if(data.categoery[0]) {
                        var str_7 =
                           ...
                           // '<div class="row" style="margin-left: 0px;padding-left: 15px;padding-right: 15px;padding-top: 20px;">' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>8</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'industry4'"+')">Industry</a></td>' +
                            ...
                            '<tr style="background-color: #F9F9F9;">' +
                            '<td>9</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'education4'"+')">Education</a></td>' +
                            ...
                            '<tr  style="background-color: #F9F9F9;">' +
                            '<td>10</td>' +
                            '<td><a  ng-click="oNOffIndicators('+"'road4'"+')">Roads</a></td>' +
