        ...
        controller : ['$scope','$http','$timeout','$mdDialog',function($scope,$http,$timeout,$mdDialog){
            ...
            $scope.addWaterPcOne = function(ev)
            {
                $mdDialog.show({
                    ...
                    '<form>' +
                    '<table class="table">' +
                    '<tr><td style="padding-top: 18px; width: 140px;">Scheme Name:</td><td><input class="form-control" style="height: 40px; padding-left: 15px;" type="text" name="scheme_nam2" placeholder="scheme name" value="scheme2"  id="scheme_name1"></td>' +
                    '</tr>' +
                    '<tr><td style="padding-top: 18px;">Scheme Type:</td><td>' +
                    '<select onchange="" id="pss_water_scheme" class="form-control" style="border-radius: 0;">' +
                    ...
                    '<form>' +
                    '<table class="table">' +
                    '<tr><td style="padding-top: 18px; width: 140px;">Scheme Name:</td><td>' +
                    '<input type="text" class="form-control" style="height: 40px; padding-left: 15px;" name="scheme_nam2" placeholder="scheme name" value="scheme2"  id="scheme_name2">' +
                    '</td>' +
                    '</tr>' +
                    '<tr><td style="padding-top: 18px;">Scheme Type:</td><td>' +
                    '<select onchange="" id="pss_water_scheme1" class="form-control" style="border-radius: 0;">' +
                    ...
                    '</md-tabs>' +
                    '</div>     ' +
                    '<div style="margin-bottom: 30px;margin-right: 25px;margin-top: -30px;">' +
                    '<md-button style="float: right;background-image: unset;border-radius: 0;" ng-click="addNewLocationForWaterScheme()" class="btn btn-primary">' +
                    'Click here' +
                    '</md-button></div>' +
                    '</md-dialog>',
    ...
    function waterController($scope, $mdDialog)
    {
        ...
        $scope.waterPssStory_urban_two=function(res,latlon,index)
        {
            ...
            $mdDialog.show({
                ...
                template: '<md-dialog style="width:800px;" id="dt_dialog" aria-label="drive time">' +
                // '<md-toolbar style="background-color: white;padding-left: 10px;padding-top:20px;">' +
                '<div id="myImageId" class="container-fluid" style="padding: 15px;">' +
                    '<div class="col-md-12" style="">' +
                    '<md-button class="float-right" ng-click="cancel()" style="min-width:0;font-weight:bold;font-size:16px;">X</md-button>' +
                    '</div>'+
                    '<div class="row">' +
                    '<div class="col-md-10" style="padding-left: 30px;">' +
                    '<div style="background-color:#4E648C;color:white;text-align: center;padding-top: 5px;padding-bottom: 5px; ">' +
                    '<h4 style="border-bottom: solid 1px white; color: white;">Site Suitability Assessment for IE</h4>' +
                    '<h4 ><b>'+scheme_title+' ('+res.name+')</b></h4>'+
                    '</div>' +
                    '<div style="margin-top:0;margin-bottom: 20px;color:white;background-color:#48A947;font-size: 20px;text-align: center;">' +
                    '<h5 style="padding: 5px;margin-top: 0;">PROPOSED SITE CHARACTERISTICS</h5>' +
                    '</div>' +
                    '</div>' +
                    '<div class="col-md-2">' +
                ...
                '</div>' +
                '<div class="col-md-5">' +
                '<div id="pin_point_tw_r" width="90%"></div>' +
                '</div>' +
                '</div>'+
                '</div>' +
                '<div style="margin-bottom: 30px;margin-right: 42px;">' +
                    '<md-button style="float: right;background-image: unset;border-radius: 0;" ng-click="cancel()" class="btn btn-primary">' +'Cancel' +'</md-button>' +
                '</div>'+
                '</md-dialog>',
                parent: angular.element(document.body),
                // targetEvent: ev,
        ...
        $scope.waterPssStory_urban_three=function(res,latlon,index)
        {
            ...
            $mdDialog.show({
                ...
                '<div id="myImageId" class="container-fluid" style="padding: 15px;">' +
                    ...
                    '<div class="row">' +
                    '<div class="col-md-10" style="padding-left: 30px;">' +
                    '<div style="background-color:#4E648C;text-align: center;padding-top: 5px;padding-bottom: 5px; ">' +
                    '<h4 style="border-bottom: solid 1px white; color: white;">Site Suitability Assessment for IE</h4>' +
                    '<h4 style="color: white;margin-bottom: 0;padding-bottom: 5px;">'+scheme_title+'</h4>'+
                    '</div>' +
                    '<div style="margin-top:0;margin-bottom: 20px;color:white;background-color:#48A947;font-size: 20px;text-align: center;">' +
                    '<h5 style="padding: 5px;margin-top: 0;">PROPOSED SITE CHARACTERISTICS</h5>' +
                    '</div>' +
                ...
                '</div>' +
                '<div class="col-md-5">' +
                '<div id="map_gst_r" width="90%"></div>' +
                '</div>' +
                '</div>'+
                '</div>' +
                '<div style="margin-bottom: 30px;margin-right: 42px;">' +
                '<md-button style="float: right;background-image: unset;border-radius: 0;" ng-click="cancel()" class="btn btn-primary">' +
                'Cancel' +
                '</md-button>' +
                '</div>'+
                '</md-dialog>',
                ...
                '<div id="myImageId" class="container-fluid" style="padding: 15px;">' +
                    ...
                    '<div class="row">' +
                        '<div class="col-md-10" style="padding-left: 30px;">' +
                            '<div style="background-color:#4E648C;text-align: center;padding-top: 5px;padding-bottom: 5px; ">' +
                                '<h4 style="border-bottom: solid 1px white; color: white;">Site Suitability Assessment for IE</h4>' +
                                '<h4 style="color: white;margin-bottom: 0;padding-bottom: 5px;">'+sc_t+'</h4>'+
                            '</div>' +
                            '<div style="margin-top:0;margin-bottom: 20px;color:white;background-color:#48A947;font-size: 20px;text-align: center;">' +
                                '<h5 style="padding: 5px;margin-top: 0;">PROPOSED SITE CHARACTERISTICS</h5>' +
                            '</div>' +
                    ...
                    '<div class="row">' +
                        '<div class="col-md-7" style="padding-left: 30px;">' +
                            '<div class="col-md-12"  style="background-color:#4E648C;color:white;font-size: 20px;text-align: center;">' +
                            '<h5 style="padding: 5px;">Existence of closest '+selected_scheme+' in vicinity of proposed scheme</h5>'+
                            '</div>'+
                            '<table class="table table-bordered table-striped">' +
                            '<tr>' +
                        ...
                        '</div>' +
                        '<div class="col-md-5">' +
                            '<div id="map_installation" width="90%"></div>' +
                        '</div>' +
                    '</div>'+
                '</div>' +
                '</md-dialog>',
        ...
        $scope.waterPssStory_urban_four_gst=function(res,point,index)
        {
            ...
            $mdDialog.show({
                ...
                '</div>' +
                '<div class="col-md-5">' +
                '<div id="map_installation_gst" width="90%"></div>' +
                '</div>' +
                '</div>'+
                '</div>' +
                '</md-dialog>',
        ...
        $scope.map_installation_map_gst= function(container,point,index,zoom,res)
        {
            ...
            $("#map_installation_gst").height(325);
            setTimeout(function()
            {
                map_tw_r.invalidateSize();
                var layer=L.geoJSON(point).addTo(map_tw_r);
        ...
        $scope.waterPssStory_urban_five=function(res,point)
        {
            ...
            $mdDialog.show({
                ...
                '</div>' +
                '<div class="col-md-5">' +
                '<div id="map_installation_wwtp" width="90%"></div>' +
                '</div>' +
                '</div>'+
                '</div>' +
                '</md-dialog>',
        ...
        $scope.map_installation_map_wwtp= function(container,point,index,zoom)
        {
            ...
            $("#map_installation_wwtp").height(325);
            setTimeout(function(){
                map_tw_r.invalidateSize();
                var layer=L.geoJSON(point).addTo(map_tw_r);
                // map_tw_r.fitBounds(layer.getBounds());
                    ...
                    '<div class="row">' +
                        '<div class="col-md-7" style="padding-left: 30px;">' +
                            '<table class="table table-bordered table-striped">' +
                                ...
                                '</tr>' +
                            '</table>'+
                            '<div style="background-color:#4E648C;color: white;text-align: center;">' +
                                '<h5 style="padding: 5px;">Water Quality Result</h5>'+
                            '</div>'+
                            '<table class="table table-bordered table-striped">' +
                                '<tr>'+
            ...
            $mdDialog.show({
                ...
                '<div id="myImageId" class="container-fluid" style="padding: 15px;">' +
                    ...
                    '<div class="row">' +
                        ...
                        '</div>' +
                        '<div class="col-md-5">' +
                            '<div id="rural_two" width="90%" height="450"></div>' +
                        '</div>' +
                    '</div>'+
                '</div>' +
                '</md-dialog>',
            ...
            $scope.waterPssStory=function(res,index)
            {
                ...
                $mdDialog.show({
                    ...
                    '<div id="myImageId" class="container-fluid" style="padding: 15px;">' +
                        ...
                        '<div style="background-color:#4E648C;text-align: center;padding-top: 5px;padding-bottom: 5px; ">' +
                        '<h4 style="border-bottom: solid 1px white; color: white;">Site Suitability Assessment for IE</h4>' +
                        '<h4 style="color: white;margin-bottom: 0;padding-bottom: 5px;"><b> Replacement of '+$scope.sc_type+ '</b></h4>'+
                        '</div>' +
                        '<div style="margin-top:0;margin-bottom: 20px;color:white;background-color:#48A947;font-size: 20px;text-align: center;">' +
                        '<h5 style="padding: 5px;margin-top: 0;">PROPOSED SITE CHARACTERISTICS</h5>' +
                        '</div>' +
                    ...
                    '</table>' +
                    '<div class="col-md-12"  style="background-color:#4E648C;color:white;font-size: 20px;text-align: center;">' +
                        '<h5 style="padding: 5px;">Existing Pipelines Condition in Percentage(%)</h5>'+
                    '</div>'+
                    '<table class="table table-bordered table-striped">'+
                    '<tr>' +
