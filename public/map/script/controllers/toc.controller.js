...
selectionApp.directive('tocTemplate',function(){
        return{
            ...
            controller : ['$scope','$http','$timeout', '$mdDialog',function($scope,$http,$timeout,$mdDialog){
				...
				$scope.userDataDialogue = function(ev) {
                   
                    $mdDialog.show({
                        controller: DialogController,
                        template: '<md-dialog id="dt_dialog11" aria-label="drive time">' +
                        '<md-toolbar>'+
                        '<div class="md-toolbar-tools" style="background-color:#29323C;color:#7A7B7C;">'+
                        '<h2>User data</h2>'+
                        '<span flex></span>'+
                        '<md-button class="md-icon-button" ng-click="cancel()">'+
                        '<md-icon md-svg-src="images/ic_clear_black_24px.svg" class="editColor" aria-label="Close dialog"></md-icon>'+
                        '</md-button>'+
                        '</div>'+
                        '</md-toolbar>' +
            ...
            success: function callback(response) {
                ...
                for(var i=0;i<response.length;i++){
                    ...
                    str=str+'<tr>'+
                        ...
                        '<td>'+response[i].data_description+'</td>'+
               ...
               //     });
                ...
                $scope.driveTimeInputDialig = function(ev) {
                    ...
                    $mdDialog.show({
                        ...
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Drive Time:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="drivetime" placeholder="1 2 3" value="10 20 30" id="drivetime"></td>' +
                        '</tr>' +
                        '<tr>'+
                        '<td>&nbsp;</td>' +
                        '<td>' +
                        '<md-button ng-click="createServiceAreaFunction()" style="float: right;background-image: unset;border-radius: 0;margin-right: 0;" class="btn btn-primary">Calculate</md-button>' +
                        '<md-button ng-click="removegptaskfunction()" style="float: right;background-image: unset;border-radius: 0;" class="btn btn-primary">Stop</md-button>' +
                        '</td>'+
                        '</tr>'+
                        '</table>' +
                        '</div>' +
                ...
                $scope.driveTimeSHPInputDialig = function(ev) {
                    ...
                    $mdDialog.show({
                        ...
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Drive Time:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="drivetime" placeholder="1 2 3" value="10 20 30" id="drivetimeShp"></td>' +
                        '</tr>' +
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Upload Shapefile:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px; display:none;" type="file" id="shpSA" class="ng-hide fileclass" accept=".zip"></td>' +
                        '</tr>' +
                        '<tr>'+
                        '<td>&nbsp;</td>' +
                        '<td>' +
                        '<md-button ng-click="uploadFile('+"'"+'shpSA'+"'"+')" style="float: right;background-image: unset;border-radius: 0;margin-right: 0;" class="btn btn-primary">Calculate</md-button>' +
                        '<md-button ng-click="removegptaskfunction()" style="float: right;background-image: unset;border-radius: 0;" class="btn btn-primary">Stop</md-button>' +
                        '</td>'+
                        '</tr>'+
                        '</table>' +
                ...
                $scope.createBufferOnLineData=function(ev){
                    $mdDialog.show({
                        ...
                        '<table style="margin-top: 10px;">' +
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Buffer in KM:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="buffer" placeholder="1" value="1" id="bufferOnline"></td>' +
                        '</tr>' +
                        '</table>' +
                        '</div>' +
                ...
                $scope.calculatePopulationFromBufferDialig = function(ev) {
                    ...
                    $mdDialog.show({
                        ...
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Buffer in KM:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="buffer" placeholder="1" value="1" id="bufferPopulation"></td>' +
                        '</tr>' +
                        '<tr>'+
                        '<td>&nbsp;</td>' +
                        '<td>' +
                        '<md-button ng-click="createBufferPopulationFunction()" style="float: right;background-image: unset;border-radius: 0;margin-right: 0;" class="btn btn-primary">Calculate</md-button>' +
                        '<md-button ng-click="removeBufferfunction()" style="float: right;background-image: unset;border-radius: 0;" class="btn btn-primary">Stop</md-button>' +
                        '</td>'+
                        '</tr>'+
                        '</table>' +
                        '</div>' +
                ...
                $scope.pointBufferPointInputDialig = function(ev) {
                    ...
                    $mdDialog.show({
                        ...
                        '<tr>' +
                        '<td style="padding-top: 0; width: 100px;">Buffer in KM:</td>' +
                        '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="buffer" placeholder="1" value="1" id="bufferPoint"></td>' +
                        '</tr>' +
                        '<tr>'+
                        '<td>&nbsp;</td>' +
                        '<td>' +
                        '<md-button ng-click="createBufferPointFunction()" style="float: right;background-image: unset;border-radius: 0;margin-right: 0;" class="btn btn-primary">Calculate</md-button>' +
                        '<md-button ng-click="removeBufferfunction()" style="float: right;background-image: unset;border-radius: 0;" class="btn btn-primary">Stop</md-button>' +
                        '</td>'+
                        '</tr>'+
                        '</table>' +
                ...
                $scope.driveTimeGeojsonInputDialig = function(ev) {
                    ...
                    $mdDialog.show({
                        ...
                        '</md-toolbar>' +
                            ...
                            '<tr>' +
                            '<td style="padding-top: 0; width: 100px;">Drive Time:</td>' +
                            '<td><input class="form-control shadow-none" style="width:270px; height: 40px;" type="text" name="drivetime" placeholder="1 2 3" value="10 20 30" id="drivetimeGjson"></td>' +
                            '</tr>' +
                            '<tr>' +
                            '<td style="padding-top: 0; width: 100px;">Upload Shapefile:</td>' +
                            '<td><input class="form-control shadow-none" style="width:270px; height: 40px; display:none;" type="file" id="geojsonSA" class="ng-hide fileclass" accept=".geojson"></td>' +
                            '</tr>' +
                            '<tr>'+
                            '<td>&nbsp;</td>' +
                            '<td>' +
                            '<md-button ng-click="uploadFile('+"'"+'geojsonSA'+"'"+')" style="float: right;background-image: unset;border-radius: 0;margin-right: 0;" class="btn btn-primary">Calculate</md-button>' +
                            '<md-button ng-click="removegptaskfunction()" style="float: right;background-image: unset;border-radius: 0;" class="btn btn-primary">Stop</md-button>' +
                            '</td>'+
                            '</tr>'+
                            '</table>' +
                ...
                function DialogController($scope,$rootScope, $mdDialog,$compile,ivhTreeviewOptions) {
                   ...
                   // $scope.catalogfinalArray=[];
					...
					$rootScope.cancelDataDialog = function() {
						   $mdDialog.hide();
						};
...
var lyr=[];
	 ...
	 function loadUsershp(furl,name,id){
         console.log(id);
        // var myLayer = 'udata'+id;
        // var newId = 'udata'+id;
        // alert(newId);
		 $("#loader").show();
		// console.log(furl)
		...
		var res = encodeURI(uri); 
	        $.ajax({
	            ...
	            success: function callback(response) {
					$("#loader").hide();
	                console.log(response); 
	                 // var polygonLayer = new L.GeoJSON.AJAX("response");       
	                   //   polygonLayer.getLayers()[0].addTo(drawnItems);
					   //L.geoJSON(response).addTo(map);]
					   angular.element(document.getElementById("dt_dialog11")).remove();
                       
                         lyr[id] = L.geoJSON().addTo(map);
                      

                          strChkox +='<label for="udata" style="margin-left: 40px !important;">'+
                          '<input type="checkbox" class="chk" name="gjlayer" value="Bike" onclick="addRemoveLayer('+id+')" id="'+id+'" checked>'+
                          ' '+name+' </label>'; 

                        $("#udatachk").html(strChkox);

					   for(var i=0;i<response.features.length;i++){
                        lyr[id].addData(response.features[i].geometry);
					   }
