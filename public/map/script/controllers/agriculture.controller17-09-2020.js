        ...
        controller : ['$scope','$http','$timeout','$mdDialog','$compile',function($scope,$http,$timeout,$mdDialog,$compile){
            ...
            $scope.addAgriculturePcOne=function(){
                ...
                var sub_cat_tab;
                    ...
                    '<tr><td>Scheme Name:</td><td><input type="text" name="scheme_nam" placeholder="scheme name test" value="scheme1"  id="scheme_name"></td>' +
                    '</tr>' +
            ...
            function agricultureController($scope, $mdDialog){
                ...
                $scope.pssAgricultureStory=function(lon,lat,sc_name,cost,cat,data_fishnet,mills_count,t_crops){
                    ...
                    $mdDialog.show({
                        ...
                        '<h4 style="text-align: center;border-bottom: solid 1px white">Assessment Report of Agriculture Scheme</h4>' +
                        '</div>' +
                        ...
                        //***********************End of top heading*************************************************
                            ...
                            //map div
                            '<div class="col-md-6" style="height: 420px" id="map4">' +
